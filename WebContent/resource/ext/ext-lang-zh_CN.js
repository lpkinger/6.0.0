 ...
 */
		/**
		 * extjs4 MessageBox的button 汉化bug
    	 * @update yingp
    	 * @date 2012-08-08 23:26:56
    	 */
 if(Ext.MessageBox){
...
Ext.onReady(function(){
    ...
    if(Ext.tab.Tab) {
    	Ext.tab.Tab.closeText = "关闭";
    }

    if(Ext.form.field.Base){
       Ext.form.field.Base.prototype.invalidText = "输入值非法";
       Ext.form.field.Base.waitTitle = "请稍等...";
    }
    ...
    if(Ext.util.Format){
        Ext.apply(Ext.util.Format, {
            ...
            //dateFormat: 'y年m月d日'
            dateFormat: 'Y-m-d' //update by yingp erp项目日期统一使用y-m-d
        });
    }
    ...
    if(Ext.picker.Date){
       Ext.apply(Ext.picker.Date.prototype, {
          ...
          todayTip          : "{0} (空格键选择)",
          //format            : "y年m月d日"
          format            : "Y-m-d" //update by yingp erp项目日期统一使用y-m-d
       });
    }
    ...
    if(Ext.form.field.Number){
       Ext.apply(Ext.form.field.Number.prototype, {
          ...
          maxText : "该输入项的最大值是 {0}",
          nanText : "{0} 不是有效数值",
          onlyIntegerText : "只能输入整型数字",
          negativeText : "只能输入大于0的数字"
       });
    }
    ...
    if(Ext.picker.Time){
		Ext.apply(Ext.picker.Time.prototype, {
          format       : 'H:i'
       });
	}
    ...
    if(Ext.form.field.VTypes){
       Ext.apply(Ext.form.field.VTypes, {
          emailText    : '该输入项必须是电子邮件地址，格式如： "user@usoftchina.com"',
          urlText      : '该输入项必须是URL地址，格式如： "http:/'+'/www.usoftchina.com"',
    ...
    if(Ext.grid.PropertyColumnModel){
       Ext.apply(Ext.grid.PropertyColumnModel.prototype, {
          ...
          valueText  : "值",
          //dateFormat : "y年m月d日"
          dateFormat : "Y-m-d" //update by yingp
       });
    }
