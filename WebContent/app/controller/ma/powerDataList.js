Ext.QuickTips.init();
Ext.define('erp.controller.ma.powerDataList', {
	extend : 'Ext.app.Controller',
	requires : ['erp.util.BaseUtil', 'erp.util.FormUtil', 'erp.util.RenderUtil'],
	views : ['ma.powerDataList.powerDataList','ma.powerDataList.powerDataListView','ma.powerDataList.powerDataListToolBar'],
	init : function() {
		var me = this;
