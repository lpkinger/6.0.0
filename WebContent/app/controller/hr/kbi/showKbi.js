Ext.QuickTips.init();
Ext.define('erp.controller.hr.kbi.showKbi', {
    extend: 'Ext.app.Controller',
    requires: ['erp.util.FormUtil', 'erp.util.GridUtil', 'erp.util.BaseUtil', 'erp.util.RenderUtil'],
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
     		'common.batchDeal.Viewport','common.batchDeal.Form','hr.kbi.showKbi',
...
//    			}
//    		},
    	/*	'triggerfield[id=ks_key]':{
    			afterrender:function(){
    				var date=Ext.getCmp('ks_key').getValue();
    			...
    			beforerender:function(btn){    				
    				btn.handler=function(select){    					
    					...
    					if(grid.getGridColumnsAndStore){
    						grid.loadNewStore(grid, 'hr/kbi/singleGridPanel.action', gridParam, "");
    					}
    					if(select == true) {
