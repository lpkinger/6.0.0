Ext.QuickTips.init();
Ext.define('erp.controller.hr.kbi.KBIAssess', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    GridUtil: Ext.create('erp.util.GridUtil'),
    views:[
    		'hr.kbi.KBIAssess','core.form.Panel','core.form.FileField','core.form.MultiField','core.form.CheckBoxGroup','core.trigger.MultiDbfindTrigger',
  			...
  			'core.button.Audit','core.button.Close','core.button.Delete','core.button.Update','core.button.ResSubmit','core.grid.Panel2','core.button.VoCreate','core.button.CheckKBIman',
	...
	init:function(){
		...
		this.control({
			...
			'dbfindtrigger[name=kad_man]': {
    			afterrender:function(trigger){
	    			trigger.dbKey='ka_detp';
	    			trigger.mappingKey='em_depart';
	    			trigger.dbMessage='请先选择考核部门';
    			}
    		},
    		'multidbfindtrigger2[name=kad_detpboss]': {
    			afterrender:function(trigger){
	    			trigger.dbKey='ka_detp';
	    			trigger.mappingKey='em_depart';
	    			trigger.dbMessage='请先选择考核部门';
    		...
    		'multidbfindtrigger2[name=kad_detpasses]': {
    			afterrender:function(trigger){
	    			trigger.dbKey='ka_detp';
	    			trigger.mappingKey='em_depart';
	    			trigger.dbMessage='请先选择考核部门';
			...
			'erpAddButton': {
				click: function(){
					me.FormUtil.onAdd('addKBIAssess', '新增KBI考评人申请', 'jsps/hr/kbi/kBIAssess.jsp');
				}
			},'erpSubmitButton': {
