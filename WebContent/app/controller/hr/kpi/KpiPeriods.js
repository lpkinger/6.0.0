Ext.QuickTips.init();
Ext.define('erp.controller.hr.kpi.KpiPeriods', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    GridUtil: Ext.create('erp.util.GridUtil'),
    views:[
    		'hr.kpi.KpiPeriods','core.form.Panel','core.form.FileField','core.form.MultiField','core.form.CheckBoxGroup','core.trigger.MultiDbfindTrigger',
	...
	init:function(){
		...
		this.control({
			...
			'erpAddButton': {
				click: function(){
					me.FormUtil.onAdd('addKpiPeriods', '新增期间类型定义', 'jsps/hr/kpi/kpiPeriods.jsp');
				}
			},'erpSubmitButton': {
