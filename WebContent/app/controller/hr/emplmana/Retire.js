Ext.QuickTips.init();
Ext.define('erp.controller.hr.emplmana.Retire', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    GridUtil: Ext.create('erp.util.GridUtil'),
    views:[
   		'hr.emplmana.Retire','core.form.Panel','core.grid.Panel2','core.toolbar.Toolbar',
    ...
    init:function(){
    	...
    	this.control({ 
    		...
    		'erpAddButton': {
    			click: function(){
    				me.FormUtil.onAdd('addRetire', '新增用人申请', 'jsps/hr/emplmana/employee/Retire.jsp');
    			}
    		},'erpSubmitButton': {
