Ext.QuickTips.init();
Ext.define('erp.controller.hr.emplmana.ContractRenew', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    GridUtil: Ext.create('erp.util.GridUtil'),
    views:[
    		'hr.emplmana.ContractRenew','core.form.Panel','core.form.FileField','core.form.MultiField','core.form.CheckBoxGroup',
	...
	init:function(){
		...
		this.control({
			...
			'erpAddButton': {
				click: function(){
					me.FormUtil.onAdd('addContractRenew', '新增名片印制', 'jsps/hr/emplmana/contract/contractRenew.jsp');
				}
			},'erpSubmitButton': {
