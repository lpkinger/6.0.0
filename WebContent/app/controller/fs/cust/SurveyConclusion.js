Ext.QuickTips.init();
Ext.define('erp.controller.fs.cust.SurveyConclusion', {
	extend : 'Ext.app.Controller',
	FormUtil : Ext.create('erp.util.FormUtil'),
	views : ['core.form.Panel', 'fs.cust.SurveyConclusion','core.form.MultiField','core.button.Save',
	...
	save: function(){
		...
		Ext.Ajax.request({
	   		url : basePath + 'fs/cust/saveSurveyConclusion.action',
	   		params : params,
	   		method : 'post',
