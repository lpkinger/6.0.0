Ext.QuickTips.init();
Ext.define('erp.controller.fs.cust.CustCreditStatus', {
	extend : 'Ext.app.Controller',
	FormUtil : Ext.create('erp.util.FormUtil'),
	GridUtil : Ext.create('erp.util.GridUtil'),
	BaseUtil : Ext.create('erp.util.BaseUtil'),
	views : ['core.form.Panel', 'fs.cust.CustCreditStatus', 'core.grid.Panel2','core.toolbar.Toolbar', 'core.form.MultiField','core.button.Save',
	...
	beforeSave:function(){
		...
		var grid1 = Ext.getCmp('customerborrowing');	
		var grid2 = Ext.getCmp('guaranty');
	...
	save: function(){
		...
		Ext.Ajax.request({
	   		url : basePath + 'fs/cust/saveCreditStatus.action?_noc=1',
	   		params : params,
	   		method : 'post',
