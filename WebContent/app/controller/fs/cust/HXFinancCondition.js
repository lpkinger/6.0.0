Ext.QuickTips.init();
Ext.define('erp.controller.fs.cust.HXFinancCondition', {
	extend : 'Ext.app.Controller',
	FormUtil : Ext.create('erp.util.FormUtil'),
	views : ['core.form.Panel', 'fs.cust.HXFinancCondition','core.form.MultiField', 'core.grid.Panel2',
	        'core.button.Save','core.button.Add','core.button.Submit', 'core.button.Upload','core.button.ResAudit','core.button.Audit','core.button.Close',
	...
	save: function(){
		...
		Ext.Ajax.request({
	   		url : basePath + 'fs/cust/saveHXFinancCondition.action?_noc=1',
	   		params : params,
	   		method : 'post',
