Ext.QuickTips.init();
Ext.define('erp.controller.plm.task.Projecttask', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    GridUtil: Ext.create('erp.util.GridUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
    		'plm.task.Projecttask','plm.task.TeammemberTreePanel','common.datalist.Toolbar','plm.task.TaskGrid',
    ...
    init:function(){
    	this.control({ 
    	    'erpTeammemberTreePanel': {
    			itemmousedown: function(selModel, record){
    				if(record.get('leaf')){	
    				var code=record.get('qtitle');
    				condition="ra_resourcecode='"+code+"'";
