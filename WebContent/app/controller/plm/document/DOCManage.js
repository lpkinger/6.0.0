Ext.QuickTips.init();
Ext.define('erp.controller.plm.document.DOCManage', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    GridUtil: Ext.create('erp.util.GridUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
    		'plm.document.DOCManage','plm.document.DocumentTreePanel','common.datalist.GridPanel','common.datalist.Toolbar',
    ...
    init:function(){
    	this.control({ 
    		...
    		'button[id=treeadd]':{
    		  click:function(btn){
    		  var id=Ext.getCmp('DocumentTree').select.id;
			  	var win = new Ext.window.Window({
				    ...
				    layout : 'anchor',
   				    items: [{
			    	      ...
			    	      anchor : '100% 100%',
			    	      layout : 'fit',
   				    	  html : '<iframe id="iframe_' + caller + '" src="' + basePath + 'jsps/plm/document/documentForm.jsp?whoami=Document!Dir&parentId='+id 
			  	...
			  	var win = new Ext.window.Window({
			    	id : 'win',
   				    ...
   				    items: [{
   				    	  ...
   				    	  anchor : '100% 100%',
   				    	  layout : 'fit',
   				    	  html : '<iframe id="iframe_' + caller + '" src="' + basePath + 'jsps/oa/knowledge/KnowledgeForm.jsp?whoami=KnowledgeKind&formCondition=parentId='+id 
   				    	  +'" height="100%" width="100%" frameborder="0" scrolling="no"></iframe>'
   				    }],
         ...
         'button[id=treedelete]':{
            click:function(btn){
            var tree=Ext.getCmp('DocumentTree');
