Ext.QuickTips.init();
Ext.define('erp.controller.crm.marketmgr.projectanalyse.ProdAnalyse', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
    		'crm.marketmgr.projectanalyse.ProdAnalyse','core.form.Panel','core.form.FileField','core.form.MultiField',
	...
	init:function(){
		...
		this.control({
			...
			'erpAddButton': {
				click: function(){
					me.FormUtil.onAdd('addProdAnalyse', '新增产品立项分析报告', 'jsps/crm/marketmgr/projectanalyse/prodAnalyse.jsp');
				}
			},'erpSubmitButton': {
