Ext.QuickTips.init();
Ext.define('erp.controller.crm.marketmgr.marketresearch.MProjectPlan', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    GridUtil: Ext.create('erp.util.GridUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
    		'crm.marketmgr.marketresearch.MProjectPlan','core.form.Panel','core.grid.Panel2','core.toolbar.Toolbar',
    ...
    init:function(){
    	...
    	this.control({ 
    		...
    		'erpAddButton': {
    			click: function(){
    				me.FormUtil.onAdd('addMProjectPlan', '新增调研项目单', 'jsps/crm/marketmgr/marketresearch/mProjectPlan.jsp');
    			}
    		},'erpSubmitButton': {
				...
				click: function(btn){
					me.FormUtil.onSubmit(Ext.getCmp('prjplan_id').value);
				}
			},
			'erpResSubmitButton': {
				afterrender: function(btn){
