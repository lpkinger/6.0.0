Ext.QuickTips.init();
Ext.define('erp.controller.crm.chance.StageChange', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
    		'crm.chance.StageChange','core.form.Panel','core.form.FileField','core.form.MultiField','core.form.CheckBoxGroup',
	...
	init:function(){
		...
		this.control({
			...
			'erpAddButton': {
				click: function(){
					me.FormUtil.onAdd('addStageChange', '新增商机进度维护单', 'jsps/crm/chance/stageChange.jsp');
				}
			},'erpSubmitButton': {
...
/*			'textfield[id=sc_prjname]':{
				change:function(btn){
					var form=Ext.getCmp('form');
					setTimeout.('alert(11)',10);
				}
			},*/
			'dbfindtrigger[name=sc_chcode]':{
