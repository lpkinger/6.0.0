Ext.QuickTips.init();
Ext.define('erp.controller.crm.customermgr.accountingmgr.CollectionPlan', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
    		'crm.customermgr.accountingmgr.CollectionPlan','core.form.Panel','core.form.FileField','core.form.MultiField',
	...
	init:function(){
		...
		this.control({
			...
			'erpAddButton': {
				click: function(){
					me.FormUtil.onAdd('addCollectionPlan', '新增收款计划', 'jsps/crmcustomermgr/accountingmgr/collectionPlan.jsp');
				}
			},
			'erpCloseButton': {
				click: function(btn){
