Ext.QuickTips.init();
Ext.define('erp.controller.crm.customermgr.development.Schedule', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
    		'crm.customermgr.development.Schedule','core.form.Panel','core.form.FileField','core.form.MultiField',
	...
	init:function(){
		...
		this.control({
			...
			'erpAddButton': {
				click: function(){
					me.FormUtil.onAdd('addSchedule', '新增日程', 'jsps/crm/customermgr/development/schedule.jsp');
				}
			},
			'erpCloseButton': {
				click: function(btn){
				...
				afterrender:function(btn){
					//console.log(parent.Ext.getCmp('showform').getForm().getValues(false,true));
