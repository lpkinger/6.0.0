Ext.QuickTips.init();
Ext.define('erp.controller.crm.customermgr.customervisit.AssistRequireDetail', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
    		'crm.customermgr.customervisit.AssistRequireDetail','core.form.Panel','core.form.FileField','core.form.MultiField',
	...
	init:function(){
		...
		this.control({
			...
			'erpDeleteButton' : {
				click: function(btn){
					me.FormUtil.onDelete(Ext.getCmp('ard_id').value);
				}
			},
			'erpUpdateButton': {
				click: function(btn){
			...
			'erpAddButton': {
				click: function(){
					//me.FormUtil.onAdd('addAssistRequireDetail', '新增商机', 'jsps/crm/chance/chance.jsp');
				}
			},
