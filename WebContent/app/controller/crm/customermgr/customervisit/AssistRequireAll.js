Ext.QuickTips.init();
Ext.define('erp.controller.crm.customermgr.customervisit.AssistRequireAll', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    GridUtil: Ext.create('erp.util.GridUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
    		'crm.customermgr.customervisit.AssistRequireAll','core.form.Panel','core.grid.Panel2','core.toolbar.Toolbar',
    		...
    		'core.button.Add','core.button.Submit','core.button.Audit','core.button.Save','core.button.Close','core.button.Print',
    			...
    			'core.trigger.DbfindTrigger','core.form.YnField','core.button.DeleteDetail','core.button.Upload',
    			'core.form.FileField','core.grid.YnColumn',
    ...
    init:function(){
    	...
    	this.control({ 
    		...
    		'erpAddButton': {
    			click: function(btn){
    				me.FormUtil.onAdd('addAssistRequireAll', '新增协助申请', 'jsps/crm/customermgr/customervisit/assistRequire.jsp');
    			}
    		},
    		'erpCloseButton': {
    			click: function(btn){
