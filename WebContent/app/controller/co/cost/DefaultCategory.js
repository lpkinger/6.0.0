Ext.QuickTips.init();
Ext.define('erp.controller.co.cost.DefaultCategory', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    GridUtil: Ext.create('erp.util.GridUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
     		'core.grid.Panel4','core.toolbar.Toolbar3','co.cost.DefaultCategory',
     		'core.button.Save',
     		'core.trigger.DbfindTrigger','core.trigger.HrOrgTreeDbfindTrigger'
	...
	update:function(param){
		Ext.Ajax.request({
		    url: basePath+'fa/ars/updateDefaultCategory.action',
		    params:{
		    	param:param
		    },
