Ext.QuickTips.init();
Ext.define('erp.controller.co.cost.ContractCostClose', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    GridUtil: Ext.create('erp.util.GridUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
    		'core.form.Panel','co.cost.ContractCostClose','core.grid.Panel2','core.toolbar.Toolbar','core.form.ColorField','core.form.YnField',
    ...
    init:function(){
       var me=this;
    	this.control({ 
    		...
    		'erpAddButton': {
    			click: function(){
    				me.FormUtil.onAdd('addContractCostClose', '新增主营成本结转(合同)结转', 'jsps/co/cost/contractCostClose.jsp');
    			}
    		},
    		'erpSubmitButton': {
    			afterrender: function(btn){
	   			...
	   			click: function(btn){
	   				warnMsg("确定要生成凭证吗?", function(btn){
	   					if(btn == 'yes'){
	   	    				...
	   	    				Ext.Ajax.request({
	   	    			   		url : basePath + 'co/cost/createCostVoucher.action',
	   	    			   		params: {
	   	    			   			id: id,
	   	    			   			caller: caller
	   	    			   		},
	   			...
	   			click: function(btn){
	   				warnMsg("确定要取消凭证吗?", function(btn){
	   					if(btn == 'yes'){
	   						...
	   						me.FormUtil.setLoading(true);//loading...
	   	    				Ext.Ajax.request({
	   	    			   		url : basePath + 'co/cost/cancelCostVoucher.action',
	   	    			   		params: {
	   	    			   			id: id,
	   	    			   			caller: caller
	   	    			   		},
