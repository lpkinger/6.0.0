Ext.QuickTips.init();
Ext.define('erp.controller.oa.persontask.OADaily', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
    		'oa.persontask.OADaily','core.form.Panel','core.form.FileField','core.form.MultiField',
    ...
    init:function(){
    	...
    	this.control({ 
			...
			'erpAddButton': {
				click: function(){
					me.FormUtil.onAdd('addOADaily', '新增日报', 'jsps/oa/persontask/oadaily.jsp');
				}
			},
			'erpCloseButton': {
				click: function(btn){
