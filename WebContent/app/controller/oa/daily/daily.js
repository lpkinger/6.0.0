Ext.QuickTips.init();
Ext.define('erp.controller.oa.daily.daily', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    GridUtil: Ext.create('erp.util.GridUtil'),
    views:[
    		'oa.daily.daily','core.form.Panel','core.grid.Panel2','core.toolbar.Toolbar','core.form.MultiField',
    	...
    	this.control({ 
    		...
    		'erpSaveButton': {
				click: function(btn){
					...
					//form.da_recordid.setValue(em_code);
					//console.log('formdata',form.da_recorderid)
					Ext.getCmp('da_recordername').setValue(em_name);
					//form.da_recordername=(em_name);
    		...
    		'erpDeleteButton': {
    			click: function(btn){
    				me.FormUtil.onDelete(Ext.getCmp('da_id').value);
    			}
    		},
    		'erpAddButton': {
    			click: function(){
    		...
    		'erpSubmitButton': {
    			...
    			click: function(btn){
    				Ext.getCmp('da_committime').setValue(new Date());
    		...
    		'erpPrintButton': {
    			click:function(btn){
				var reportName="ECR";
				var condition='{Ecr.da_id}='+Ext.getCmp('da_id').value+'';
				var id=Ext.getCmp('da_id').value;
