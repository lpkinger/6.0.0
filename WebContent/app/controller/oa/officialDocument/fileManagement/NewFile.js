Ext.QuickTips.init();
Ext.define('erp.controller.oa.officialDocument.fileManagement.NewFile', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
    		'oa.officialDocument.fileManagement.NewFile','core.form.Panel','core.form.FileField',
    		'core.button.Save','core.button.Close','core.button.Update','core.button.Delete','core.form.WordSizeField',
    ...
    init:function(){
    	...
    	this.control({ 
    		...
    		'erpDeleteButton': {
    			click: function(btn){
    				me.onDelete((Ext.getCmp('fi_id').value));
    			}
    		},
    		'erpCloseButton': {
    			click: function(btn){
