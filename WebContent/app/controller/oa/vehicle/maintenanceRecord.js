Ext.QuickTips.init();
Ext.define('erp.controller.oa.vehicle.maintenanceRecord', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
    		'oa.vehicle.maintenanceRecord','core.form.Panel',
    ...
    init:function(){
    	...
    	this.control({ 
    		...
    		'erpAddButton': {
    			click: function(btn){
    				me.FormUtil.onAdd('addMaintenanceRecord', '新增维修保养记录', 'jsps/oa/vehicle/maintenanceRecord.jsp');
    			}
    		},
    		'erpUpdateButton': {
    			click: function(btn){
