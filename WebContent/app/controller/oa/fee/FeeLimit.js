Ext.QuickTips.init();
Ext.define('erp.controller.oa.fee.FeeLimit', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    GridUtil: Ext.create('erp.util.GridUtil'),
    views:[
    		'oa.fee.FeeLimit','core.form.Panel','core.form.FileField','core.form.MultiField','core.form.CheckBoxGroup','core.trigger.MultiDbfindTrigger',
	...
	init:function(){
		...
		this.control({
			...
			'erpDeleteButton' : {
				click: function(btn){
					me.FormUtil.onDelete(Ext.getCmp('fl_id').value);
				}
			},
			'erpUpdateButton': {
				click: function(btn){
			...
			'erpAddButton': {
				click: function(){
					me.FormUtil.onAdd('addFeeLimit', '新增额度维护', 'jsps/oa/fee/feeLimit.jsp');
				}
			},'erpSubmitButton': {
				afterrender: function(btn){
					var status = Ext.getCmp('fl_statuscode');
					if(status && status.value != 'ENTERING'){
						btn.hide();
					}
				},
				click: function(btn){
					me.FormUtil.onSubmit(Ext.getCmp('fl_id').value);
				}
			},'erpResSubmitButton': {
				afterrender: function(btn){
					var status = Ext.getCmp('fl_statuscode');
				...
				click: function(btn){
					me.FormUtil.onResSubmit(Ext.getCmp('fl_id').value);
				}
			},
			'erpAuditButton': {
				afterrender: function(btn){
				...
				click: function(btn){
					me.FormUtil.onAudit(Ext.getCmp('fl_id').value);
				}
			},
			'erpResAuditButton': {
				afterrender: function(btn){
				...
				click: function(btn){
					me.FormUtil.onResAudit(Ext.getCmp('fl_id').value);
				}
			},
			'erpCloseButton': {
				click: function(btn){
