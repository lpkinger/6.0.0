Ext.QuickTips.init();
Ext.define('erp.controller.oa.fee.TiCheng', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    GridUtil: Ext.create('erp.util.GridUtil'),
    views:[
    		'oa.fee.TiCheng','core.form.Panel','core.form.FileField','core.form.MultiField','core.form.CheckBoxGroup','core.trigger.MultiDbfindTrigger',
	...
	init:function(){
		...
		this.control({
			...
			'erpAddButton': {
				click: function(){
					me.FormUtil.onAdd('addTiCheng', '新增提成单', 'jsps/oa/fee/tiCheng.jsp');
				}
			},'erpSubmitButton': {
			...
			'erpResAuditButton': {
				...
				click: function(btn){
					me.FormUtil.onResAudit(Ext.getCmp('tc_id').value);
				}
			},
			'erpCloseButton': {
				click: function(btn){
