Ext.QuickTips.init();
Ext.define('erp.controller.oa.publicAdmin.book.returnManage.RenewDeal', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
    		'oa.publicAdmin.book.returnManage.RenewDeal','common.datalist.GridPanel','common.datalist.Toolbar',
