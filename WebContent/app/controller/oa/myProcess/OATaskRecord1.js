Ext.QuickTips.init();
Ext.define('erp.controller.oa.myProcess.OATaskRecord1', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
    		'oa.myProcess.OATaskRecord1','core.form.Panel','core.form.FileField','core.form.MultiField',
    ...
    init:function(){
    	...
    	this.control({ 
			...
			'erpAddButton': {
				click: function(){
					me.FormUtil.onAdd('addOATaskRecord', '新增任务报告', 'jsps/oa/myProcess/oataskrecord.jsp');
				}
			},
			'erpCloseButton': {
				click: function(btn){
