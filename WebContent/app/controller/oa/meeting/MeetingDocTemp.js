Ext.QuickTips.init();
Ext.define('erp.controller.oa.meeting.MeetingDocTemp', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    GridUtil: Ext.create('erp.util.GridUtil'),
    views:[
    		'oa.meeting.MeetingDocTemp','core.form.Panel','core.form.FileField','core.form.MultiField','core.form.CheckBoxGroup','core.trigger.MultiDbfindTrigger',
	...
	init:function(){
		...
		this.control({
			...
			'erpAddButton': {
				click: function(){
					me.FormUtil.onAdd('addMeetingDocTemp', '新增会议纪要模板', 'jsps/oa/meeting/meetingDocTemp.jsp');
				}
			},'erpSubmitButton': {
