...
Ext.define('erp.controller.common.CommonPage', {
    ...
    views:[
      		'core.form.Panel','common.CommonPage','core.grid.Panel2','core.toolbar.Toolbar','core.trigger.MultiDbfindTrigger','core.trigger.MultiDbfindTrigger2','core.trigger.HrOrgTreeDbfindTrigger',
      		...
      		'core.trigger.DbfindTrigger','core.trigger.TextAreaTrigger','core.form.YnField', 'core.grid.YnColumn','core.trigger.AddDbfindTrigger','core.button.Abate', 'core.button.ResAbate',
      		...
      		'core.form.MonthDateField','core.form.SpecialContainField','core.form.SeparNumber','core.form.ConDateHourMinuteField','core.button.CommonTransfer','core.button.Modify',
      		'core.form.CheckBoxGroup','core.form.RadioGroup','core.button.PrintByCondition','core.trigger.AutoCodeTrigger','core.button.LossUpdate','core.trigger.SearchField'
      	],
    init:function(){
    	var me = this;
    	...
    	this.control({
    		...
    		'dbfindtrigger[name=rd_bomdetno]': {
    			focus: function(t){
    				...
    				var bomid = record.data['rd_bomid'];    				
    				if (bomid == 0 || bomid == '0' || bomid == '' || bomid == null){
    					showError("请先选择设备编号");
