Ext.QuickTips.init();
Ext.define('erp.controller.drp.distribution.ExchangeCu', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    GridUtil: Ext.create('erp.util.GridUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
      		'core.form.Panel','drp.distribution.ExchangeCu','core.grid.Panel2','core.toolbar.Toolbar','core.form.MultiField',
    ...
    init:function(){
    	...
    	this.control({
    		...
    		'erpAddButton': {
    			click: function(){
    				me.FormUtil.onAdd('addExchangeCu', '新增退换货申请单', 'jsps/drp/distribution/exchangeCu.jsp');
    			}
    		},
    		'erpCloseButton': {
    			click: function(btn){
