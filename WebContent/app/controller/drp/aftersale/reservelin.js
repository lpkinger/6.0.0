Ext.QuickTips.init();
Ext.define('erp.controller.drp.aftersale.reservelin', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    GridUtil: Ext.create('erp.util.GridUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
      		'core.form.Panel','drp.aftersale.reservelin','core.grid.Panel2','core.toolbar.Toolbar','core.form.MultiField',
...
//    		},
    		...
    		'erpAddButton': {
    			click: function(){
    				me.FormUtil.onAdd('addReservelin', '新增备料领用单', 'jsps/drp/aftersale/reservelin.jsp');
    			}
    		},
    		'erpCloseButton': {
    			click: function(btn){
