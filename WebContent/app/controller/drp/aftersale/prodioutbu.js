Ext.QuickTips.init();
Ext.define('erp.controller.drp.aftersale.prodioutbu', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    GridUtil: Ext.create('erp.util.GridUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
      		'core.form.Panel','drp.aftersale.prodioutbu','core.grid.Panel2','core.toolbar.Toolbar','core.form.MultiField',
...
//    		},
    		...
    		'erpAddButton': {
    			click: function(){
    				me.FormUtil.onAdd('addProdioutbu', '新增采购收料单', 'jsps/drp/aftersale/prodioutbu.jsp');
    			}
    		},
    		'erpCloseButton': {
    			click: function(btn){
