Ext.QuickTips.init();
Ext.define('erp.controller.drp.aftersale.prodioutinware', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    GridUtil: Ext.create('erp.util.GridUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
      		'core.form.Panel','drp.aftersale.prodioutinware','core.grid.Panel2','core.toolbar.Toolbar','core.form.MultiField',
...
//    		},
    		...
    		'erpAddButton': {
    			click: function(){
    				me.FormUtil.onAdd('addProdioutinware', '新增采购收料单', 'jsps/drp/aftersale/prodioutinware.jsp');
    			}
    		},
    		'erpCloseButton': {
    			click: function(btn){
