Ext.QuickTips.init();
Ext.define('erp.controller.scm.sale.EngineerContrast', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    GridUtil: Ext.create('erp.util.GridUtil'),
    views:[
    		'scm.sale.EngineerContrast','core.form.Panel','core.form.FileField','core.form.MultiField','core.form.CheckBoxGroup','core.trigger.MultiDbfindTrigger',
	...
	init:function(){
		...
		this.control({
			...
			'erpAddButton': {
				click: function(){
					me.FormUtil.onAdd('addEngineerContrast', '新增工程师对照表', 'jsps/scm/sale/EngineerContrast.jsp');
				}
			},
			'erpSubmitButton': {
				afterrender: function(btn){
			...
			'erpResAuditButton': {
				...
				click: function(btn){
					me.FormUtil.onResAudit(Ext.getCmp('ec_id').value);
				}
			},
			'erpCloseButton': {
				click: function(btn){
