Ext.QuickTips.init();
Ext.define('erp.controller.scm.sale.ProductLoss', {
	extend : 'Ext.app.Controller',
	FormUtil : Ext.create('erp.util.FormUtil'),
	BaseUtil : Ext.create('erp.util.BaseUtil'),
	GridUtil : Ext.create('erp.util.GridUtil'),
	views : [ 'scm.sale.ProductLoss', 'core.form.Panel', 'core.form.FileField','core.form.MultiField', 'core.form.CheckBoxGroup',
		...
		this.control({
			...
			'erpSaveButton' : {
				...
				afterrender : function(btn) {
					var value = Ext.getCmp('pl_id').getValue();
					if (value) {
						btn.hide();
					}
				}
			...
			'erpAddButton' : {
				click : function(btn) {
					...
					//if(condition){						
    				 me.FormUtil.onAdd('addProductLoss', '新增物料损耗规则', 'jsps/scm/sale/productLoss.jsp');
