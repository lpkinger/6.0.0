Ext.QuickTips.init();
Ext.define('erp.controller.scm.sale.PaymentsDetail', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    GridUtil: Ext.create('erp.util.GridUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
      		'core.form.Panel','scm.sale.PaymentsDetail','core.grid.Panel2','core.toolbar.Toolbar',
	...
	init:function(){
		...
		this.control({
			...
			'erpAddButton': {
				click: function(){
					me.FormUtil.onAdd('addPurchasePayments', '新增付款方式', 'jsps/scm/sale/paymentsDetail.jsp');
				}
			},
			'erpCloseButton': {
				click: function(btn){
    		...
    		'erpScanButton': {
    			afterrender: function(btn){
    				btn.urlcondition = "pa_type=1 and pa_kind=1";
    			}
    		},
