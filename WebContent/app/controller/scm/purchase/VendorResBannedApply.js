Ext.QuickTips.init();
Ext.define('erp.controller.scm.purchase.VendorResBannedApply', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
    		'scm.purchase.VendorResBannedApply','core.form.Panel','core.form.MultiField','core.form.FileField',
    ...
    init:function(){
		...
		this.control({
			...
			'erpAddButton': {
				click: function(){
					me.FormUtil.onAdd('addVendorResBannedApply', '新增供应商反禁用申请单', 'jsps/scm/purchase/vendorResBannedApply.jsp');
				}
			},
			'erpCloseButton': {
				click: function(btn){
