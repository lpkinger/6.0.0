Ext.QuickTips.init();
Ext.define('erp.controller.scm.purchase.Payments', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    GridUtil: Ext.create('erp.util.GridUtil'),
    views:[
    		'scm.purchase.Payments','core.form.Panel','core.grid.Panel2',
    ...
    init:function(){
    	...
    	this.control({ 
    		...
    		'erpAddButton': {
    			click: function(){
    				me.FormUtil.onAdd('addPayments', '新增付款方式', 'jsps/scm/purchase/payments.jsp');
    			}
    		},
			'erpSubmitButton': {
