Ext.QuickTips.init();
Ext.define('erp.controller.scm.reserve.ProductWhmonthWarehouse', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
    		'scm.reserve.ProductWhmonth','common.datalist.GridPanel','common.datalist.Toolbar','common.batchDeal.Form',
    		'core.trigger.DbfindTrigger','core.form.ConDateField','core.form.MonthDateField','core.button.Refresh'
    	],
    init:function(){
    	var me = this;
    	this.control({
