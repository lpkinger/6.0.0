Ext.QuickTips.init();
Ext.define('erp.controller.scm.qc.Sample', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    GridUtil: Ext.create('erp.util.GridUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
      		'core.form.Panel','scm.qc.Sample','core.grid.Panel2','core.toolbar.Toolbar',
      		...
      		'core.button.ResSubmit','core.button.Flow','core.button.Scan',
    ...
    init:function(){
    	...
    	this.control({
    		...
    		'erpAddButton': {
    			click: function(){
    				me.FormUtil.onAdd('addSample', '新增单次抽样计划资料', 'jsps/scm/qc/sample.jsp');
    			}
    		},
    		'erpCloseButton': {
    			click: function(btn){
