Ext.QuickTips.init();
Ext.define('erp.controller.scm.product.PreProductBatch', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    GridUtil: Ext.create('erp.util.GridUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
      		'core.form.Panel','scm.product.PreProductBatch','core.grid.Panel2','core.toolbar.Toolbar','core.form.MultiField',
    ...
    init:function(){
		...
		this.control({
			...
			'erpAddButton': {
    			click: function(){
    				me.FormUtil.onAdd('addpreproductbatch', '新增批量新物料申请单', 'jsps/scm/product/preProductBatch.jsp');
    			}
    		},
			'erpDeleteButton' : {
				click: function(btn){
