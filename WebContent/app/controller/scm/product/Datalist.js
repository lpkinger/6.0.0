Ext.QuickTips.init();
Ext.define('erp.controller.scm.product.Datalist', {
    ...
    views:[
     		...
     		'core.button.VastPrint','core.button.VastReply','core.button.VastSubmit','core.button.ResAudit','core.button.Add','core.grid.YnColumn','core.form.BtnDateField'
     	],
    init:function(){
    	this.control({
    		...
    		'erpAddButton':{
    			click: function(btn){
    				var title = this.BaseUtil.getActiveTab().title;
    				this.FormUtil.onAdd(caller + '_scan', title, url);
    			}
    		},
    		'erpVastDeleteButton': {
    			click: function(btn){
