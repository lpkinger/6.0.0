Ext.QuickTips.init();
Ext.define('erp.controller.scm.product.ProdKindChange', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    GridUtil: Ext.create('erp.util.GridUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
      		'core.form.Panel','scm.product.ProdKindChange','core.grid.Panel2','core.toolbar.Toolbar','core.form.FileField',
	...
	init:function(){
		...
		this.control({
			...
			'erpAddButton': {
				click: function(){
					me.FormUtil.onAdd('addProdKindChange', '新增物料种类变更单', 'jsps/scm/product/prodKindChange.jsp?whoami=' + caller);
				}
			},
			'erpCloseButton': {
				click: function(btn){
			...
			'erpPrintButton': {
				click:function(btn){
					var reportName="ProdKindChange";
					var condition='{ProdKindChange.pc_id}='+Ext.getCmp('pc_id').value+'';
