Ext.QuickTips.init();
Ext.define('erp.controller.pm.bom.OneECN', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    GridUtil: Ext.create('erp.util.GridUtil'),
    views:[
    		'pm.bom.OneECN','core.form.Panel','core.grid.Panel2','core.toolbar.Toolbar',
    ...
    init:function(){
    	...
    	this.control({ 
    		...
    		'erpAddButton': {
    			click: function(){
    				me.FormUtil.onAdd('addECN', '新增ECN资料', 'jsps/pm/bom/oneECN.jsp');
    			}
    		},
    		'erpSubmitButton': {
