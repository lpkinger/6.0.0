Ext.QuickTips.init();
Ext.define('erp.controller.pm.make.MakeInverse', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
    		'pm.make.MakeInverse','core.form.Panel',
    ...
    init:function(){
    	...
    	this.control({ 
    		...
    		'erpAddButton': {
    			click: function(){
    				me.FormUtil.onAdd('addMakeInverse', '新增制造通知单转制造单', 'jsps/pm/make/makeInverse.jsp');
    			}
    		},
    		'erpSubmitButton': {
