Ext.QuickTips.init();
Ext.define('erp.controller.pm.make.WCPlanResult', {
    extend: 'Ext.app.Controller',
    requires: ['erp.util.FormUtil', 'erp.util.GridUtil', 'erp.util.BaseUtil', 'erp.util.RenderUtil'],
    views:[
     		'pm.make.WCPlanResult','common.query.Form','common.datalist.GridPanel','common.datalist.Toolbar',
     		'core.trigger.DbfindTrigger','core.form.FtField','core.form.FtFindField','core.form.ConDateField','core.form.BtnDateField',
...
//    		},
    		'erpQueryFormPanel': {
    			afterrender: function(f) {
    				f.down('button[name=export]').handler = function(b) {
    					var grid = Ext.getCmp('grid');
    		    		f.BaseUtil.createExcel(caller, 'datalist', grid.getCondition());
    				};
    			}
    		},
    		'erpVastDealButton': {
