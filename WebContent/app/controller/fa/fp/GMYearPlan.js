Ext.QuickTips.init();
Ext.define('erp.controller.fa.fp.GMYearPlan', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    GridUtil: Ext.create('erp.util.GridUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
   		'fa.fp.GMYearPlan','core.form.Panel','core.grid.Panel2','core.form.MultiField','core.form.FileField','core.form.YnField','core.form.MonthDateField',
    ...
    init:function(){
    	...
    	this.control({ 
    		...
    		'erpDeleteButton' : {
    			click: function(btn){
    				me.FormUtil.onDelete(Ext.getCmp('gmp_id').value);
    			}
    		},
    		'erpUpdateButton': {
    			click: function(btn){
