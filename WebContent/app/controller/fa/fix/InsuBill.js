Ext.QuickTips.init();
Ext.define('erp.controller.fa.fix.InsuBill', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    GridUtil: Ext.create('erp.util.GridUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
      		'core.form.Panel','fa.fix.InsuBill','core.grid.Panel2','core.toolbar.Toolbar',
    ...
    init:function(){
    	...
    	this.control({ 
    		...
    		'erpDeleteButton' : {
    			click: function(btn){
    				me.FormUtil.onDelete({ib_id: Number(Ext.getCmp('ib_id').value)});
    			}
    		},
    		'erpUpdateButton': {
    			click: function(btn){
    		...
    		'erpAddButton': {
    			click: function(){
    				me.FormUtil.onAdd('add' + caller, '新增', "jsps/fa/fix/insuBill.jsp?whoami=" + caller);
    			}
    		},
    		'erpCloseButton': {
    			click: function(btn){
    		...
    		'erpSubmitButton': {
    			...
    			click: function(btn){
    				me.FormUtil.onSubmit(Ext.getCmp('ib_id').value);
    			}
    		},
    		'erpResSubmitButton': {
    			afterrender: function(btn){
    			...
    			click: function(btn){
    				me.FormUtil.onResSubmit(Ext.getCmp('ib_id').value);
    			}
    		},
    		'erpAuditButton': {
    			afterrender: function(btn){
    			...
    			click: function(btn){
    				me.FormUtil.onAudit(Ext.getCmp('ib_id').value);
    			}
    		},
    		'erpResAuditButton': {
    			afterrender: function(btn){
    			...
    			click: function(btn){
    				me.FormUtil.onResAudit(Ext.getCmp('ib_id').value);
    			}
    		},
    		'erpBannedButton': {
    			afterrender: function(btn){
    			...
    			click: function(btn){
    				me.FormUtil.onBanned(Ext.getCmp('ib_id').value);
    			}
    		},
    		'erpResBannedButton': {
    			afterrender: function(btn){
    			...
    			click: function(btn){
    				me.FormUtil.onResBanned(Ext.getCmp('ib_id').value);
    			}
    		},
    		'erpPrintButton': {
    			click: function(btn){
    				me.FormUtil.onPrint(Ext.getCmp('ib_id').value);
    			}
    		},
    		'erpPostButton': {
    			afterrender: function(btn){
    		...
    		'erpScanButton': {
    			afterrender: function(btn){
    				btn.urlcondition = "ib_statuscode<>'DELETED'";
    			}
    		}
    	});
    },
