Ext.QuickTips.init();
Ext.define('erp.controller.fa.gla.ChildReportMain', {
    			   		...
    			   		callback : function(options,success,response){
    		    			...
    		    			if(localJson.success){
    		    				Ext.Array.each(localJson.children, function(node){
    		    					var url = 'jsps/fa/gla/childReport.jsp?mastercode=' + node.ss_mastercode + '&yearmonth=' + Ext.getCmp('yearmonth').value + '&fatype=' + Ext.getCmp('fatype').value + '&_noc=1';
    		    					if(node.cr_id){
