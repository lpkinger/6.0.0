Ext.QuickTips.init();
Ext.define('erp.controller.fa.gla.GeneralLedger', {
    extend: 'Ext.app.Controller',
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views: ['core.trigger.DbfindTrigger', 'fa.gla.GeneralLedger', 'fa.gla.Ledger', 'core.form.MonthDateField', 
    ...
    query: function(cond) {
    	...
    	Ext.Ajax.request({
    		url: basePath + 'fa/ars/getGeneralLedger.action',
    		params: {
