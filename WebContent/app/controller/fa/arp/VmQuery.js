Ext.QuickTips.init();
Ext.define('erp.controller.fa.arp.VmQuery', {
    extend: 'Ext.app.Controller',
    GridUtil: Ext.create('erp.util.GridUtil'),
    condition:'',
    views:[
     		'fa.arp.vmQuery.Viewport','fa.arp.vmQuery.GridPanel','fa.arp.vmQuery.QueryForm','fa.arp.vmQuery.QueryWin',
    ...
    refs: [{ref: 'grid', selector: '#vmquerygrid'}],
    init:function(){
    	var me = this;
    	this.control({
    		...
    		'button[name=refresh]':{
    			click: function(btn){
    				...
    				Ext.Ajax.request({
    					url: basePath + 'fa/arp/VmQueryController/refreshVmQuery.action',
    					method: 'GET',
    ...
    query: function(cond) {
    	...
    	Ext.Ajax.request({
    		url: basePath + 'fa/arp/VmQueryController/getVmQuery.action',
    		params: {
