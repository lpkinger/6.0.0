Ext.QuickTips.init();
Ext.define('erp.controller.fa.arp.VmCopDetailQuery', {
    extend: 'Ext.app.Controller',
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views: ['core.trigger.DbfindTrigger', 'fa.arp.VmCopDetailQuery', 'fa.arp.QueryGrid', 'core.form.MonthDateField', 
    ...
    query: function(cond) {
    	...
    	Ext.Ajax.request({
    		url: basePath + 'fa/arp/VmQueryController/getVmCopDetailQuery.action',
    		params: {
