Ext.QuickTips.init();
Ext.define('erp.controller.fa.arp.DefaultCategory', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    GridUtil: Ext.create('erp.util.GridUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
     		'core.grid.Panel4','core.toolbar.Toolbar3','core.button.Save','core.trigger.DbfindTrigger','core.trigger.HrOrgTreeDbfindTrigger','core.trigger.CateTreeDbfindTrigger'
	...
	update:function(param){
		Ext.Ajax.request({
		    url: basePath+'fa/updateDefaultCategory.action',
		    params:{
		    	param:param
		    },
