Ext.QuickTips.init();
Ext.define('erp.controller.fa.ars.CmDetailQuery', {
    extend: 'Ext.app.Controller',
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views: ['core.trigger.DbfindTrigger', 'fa.ars.CmDetailQuery', 'fa.ars.QueryGrid', 'core.form.MonthDateField', 
    ...
    query: function(cond) {
    	...
    	Ext.Ajax.request({
    		url: basePath + 'fa/ars/CmQueryController/getCmDetailQuery.action',
    		params: {
