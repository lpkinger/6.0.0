Ext.QuickTips.init();
Ext.define('erp.controller.fa.ars.ProdKind', {
    ...
    init:function(){
    	...
    	this.control({
    		...
    		'dbfindtrigger[name=pk_salecatecode]': {
    			focus: function(t){
    				Ext.getCmp('grid').dbfinds = [{
    					dbGridField:'ca_code', 
    					field: 'pk_salecatecode'
    				},{
    					dbGridField:'ca_name', 
    					field: 'pk_salecatename'
    				}];
    			}
    		},
    		'dbfindtrigger[name=pk_costcatecode]': {
    			focus: function(t){
    				Ext.getCmp('grid').dbfinds = [{
    					dbGridField: 'ca_code', 
    					field: 'pk_costcatecode'
    				},{
    					dbGridField: 'ca_name', 
    					field: 'pk_costcatename'
    				}];
    			}
    		}
    	});
    ...
    */},
	...
	update:function(param){
		console.log(param);
		Ext.Ajax.request({
		    url: basePath+'fa/ars/updateProdKind.action',
		    params:{
		    	param:param
		    },
