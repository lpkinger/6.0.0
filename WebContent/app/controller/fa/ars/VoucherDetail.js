Ext.QuickTips.init();
Ext.define('erp.controller.fa.ars.VoucherDetail', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    GridUtil: Ext.create('erp.util.GridUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
      		'core.form.Panel','fa.ars.VoucherDetail','core.grid.Panel2','core.toolbar.Toolbar',
	...
	init:function(){
		...
		this.control({
			...
			'erpAddButton': {
				click: function(){
					me.FormUtil.onAdd('addVoucherDetail', '新增凭证明细', 'jsps/fa/ars/voucherDetail.jsp');
				}
			},
			'erpCloseButton': {
				click: function(btn){
