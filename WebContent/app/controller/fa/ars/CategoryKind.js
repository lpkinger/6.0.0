Ext.QuickTips.init();
Ext.define('erp.controller.fa.ars.CategoryKind', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    GridUtil: Ext.create('erp.util.GridUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
      		'core.form.Panel','fa.ars.CategoryKind','core.grid.Panel2','core.toolbar.Toolbar',
    ...
    init:function(){
    	...
    	this.control({
    		...
    		'erpDeleteButton' : {
    			click: function(btn){
    				me.FormUtil.onDelete(Ext.getCmp('ck_id').value);
    			}
    		},
    		'erpUpdateButton': {
    			click: function(btn){
    		...
    		'erpAddButton': {
    			click: function(){
    				me.FormUtil.onAdd('addCategoryKind', '新增科目分类维护', 'jsps/fa/ars/categoryKind.jsp');
    			}
    		},
    		'erpCloseButton': {
    			click: function(btn){
