Ext.QuickTips.init();
Ext.define('erp.controller.fa.ars.CategoryDoc', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    GridUtil: Ext.create('erp.util.GridUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
      		'core.form.Panel','fa.ars.CategoryDoc','core.grid.Panel2','core.toolbar.Toolbar',
...
*/    				this.FormUtil.beforeSave(this);
    		...
    		'erpAddButton': {
    			click: function(){
    				me.FormUtil.onAdd('addCategoryDoc', '新增科目额外说明维护', 'jsps/fa/ars/categoryDoc.jsp');
    			}
    		},
    		'erpCloseButton': {
    			click: function(btn){
