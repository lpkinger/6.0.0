Ext.QuickTips.init();
Ext.define('erp.controller.vendbarcode.AcceptNotifyListDetail', {
	extend: 'Ext.app.Controller',
	requires: ['erp.util.BaseUtil', 'erp.util.FormUtil', 'erp.util.RenderUtil'],
	views:['vendbarcode.AcceptNotifyListDetail.Viewport','vendbarcode.AcceptNotifyListDetail.AcceptNotifyListDetailGridPanel','vendbarcode.vendpurchase.VendToolbar'],
	init:function(){
			this.BaseUtil = Ext.create('erp.util.BaseUtil');
	 	    this.FormUtil = Ext.create('erp.util.FormUtil');
	 	    this.GridUtil = Ext.create('erp.util.GridUtil');
	    	this.control({
	    		'acceptNotifyListDetailGrid': {
