Ext.define('erp.view.vendbarcode.barAcceptNotify.setBarcode.GridPanel',{ 
	extend: 'Ext.grid.Panel', 
	alias: 'widget.erpVendSetBarcodeGridPanel',
	requires: ['erp.view.core.grid.HeaderFilter', 'erp.view.core.toolbar.Toolbar', 'erp.view.core.plugin.CopyPasteMenu'],
	id: 'vendSetBarcodeGridPanel', 
    ...
    selModel: Ext.create('Ext.selection.CheckboxModel',{
	        ...
	        onHeaderClick: function(headerCt, header, e) {
	            ...
	            Ext.getCmp('vendSetBarcodeGridPanel').summary();
	        }
	}),
	tbar:['->',
	      {
		  ...
		  xtype:'erpVendPrintMoreButton'
	  },{
	  	  xtype:'erpVendPrintMoreBoxButton'
	  },{
