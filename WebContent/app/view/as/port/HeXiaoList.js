Ext.define('erp.view.as.port.HeXiaoList', {
	extend : 'Ext.Viewport',
	layout : 'anchor',
	hideBorders : true,
	initComponent : function() {
		...
		var store = new Ext.data.Store({
			fields : [ 'APPLYHEXIAO_NO', 'BACK_DAY', 'STORE_ID',
						'STORE_NAME', 'OBJECTIVE_STORE', 'APPLY_DATETIME',
						'APPLY_RESULT', 'APPLY_OP', 'INOUTNO', 'CLASS',
						'UPDATEMAN', 'UPDATEDATE' ],
				proxy : {
					type : 'ajax',
					url : basePath + 'as/port/getHexiaoList.action',
					reader : {
						type : 'json',
						root : 'target',
