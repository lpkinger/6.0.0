Ext.define('erp.view.oa.officialDocument.receiveODManagement.manage.Form',{ 
	extend: 'Ext.form.Panel', 
	alias: 'widget.erpRODManageFormPanel',
	id: 'form', 
    region: 'north',
    frame : true,
	layout : 'column',
	...
	tbar: [{
    	...
    	handler: function(){
			...
			if(condition != ''){
				url = "oa/officialDocument/receiveODM/search.action";
