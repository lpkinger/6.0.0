Ext.define('erp.view.oa.myProcess.jprocessEfficiency.GridPanel',{ 
	extend: 'Ext.grid.Panel', 
	alias: 'widget.erpJProcessEfficiencyGridPanel',
	id: 'grid', 
 	emptyText : '无数据',
    columnLines : true,
    autoScroll : true,
...
//				url = "oa/myprocess/getMyList.action";
	...
	initComponent : function(){ 
		...
		url = "oa/myprocess/getJNodeEfficiencyFromReviewedJProcessList.action";
//		url = "oa/myprocess/getMyList.action";
