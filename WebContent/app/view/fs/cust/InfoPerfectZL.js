Ext.define('erp.view.fs.cust.InfoPerfectZL',{ 
	extend: 'Ext.Viewport', 
	layout: 'fit',
		...
		Ext.apply(this, { 
			items: [{
				...
				items: [{ 
					...
					border : false,
					layout : 'fit',
					html : '<iframe id="iframe_add_base" src="'+basePath+'jsps/fs/cust/custSurveyBaseZL.jsp?formCondition=cq_idIS'+caid+'&gridCondition=li_cqidIS'+caid+'&readOnly='+readOnly+'&_noc=1" height="100%" width="100%" frameborder="0" scrolling="auto"></iframe>'
				},{ 
					title : '经营场所情况',
					tag : 'iframe',
					id:'manage',
