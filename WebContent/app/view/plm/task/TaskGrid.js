...
Ext.define('erp.view.plm.task.TaskGrid',{ 
	extend: 'Ext.grid.Panel', 
	alias: 'widget.erpTaskGridPanel',
	layout : 'auto',
	id: 'grid', 
 	emptyText : '无数据',
    columnLines : true,
	...
	initComponent : function(){ 
    	...
    	var datalistcondition=condition.replace(/prj_id/g,"prjplanid");
		this.getCount(caller, datalistcondition);
		...
		Ext.Ajax.request({//拿到grid的columns
        	...
        	callback : function(options,success,response){
        		...
        		if(me.columns && me.columns.length> 2){
            		...
            		Ext.getCmp('grid').reconfigure(store, res.columns);//用这个方法每次都会add一个checkbox列
        		}
        		//修改pagingtoolbar信息
        		Ext.getCmp('pagingtoolbar').afterOnLoad();
        		//拿到datalist对应的单表的关键词
