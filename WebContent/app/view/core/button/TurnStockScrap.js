 ...
 * 转报废单按钮
 */	
Ext.define('erp.view.core.button.TurnStockScrap',{ 
		extend: 'Ext.Button', 
		alias: 'widget.erpTurnStockScrapButton',
		iconCls: 'x-button-icon-submit',
    	cls: 'x-btn-gray',
    	id: 'erpTurnStockScrapButton',
    	text: $I18N.common.button.erpTurnStockScrapButton,
    	style: {
    		marginLeft: '10px'
        },
        width: 120,
		...
		handler:function(url){
			...
			if(records.length > 0){
				...
				if(bool){
					...
					Ext.Ajax.request({
				   		url : basePath + 'drp/batchTurnStockScrap.action',
				   		params: params,
				   		method : 'post',
				   		timeout: 6000000,
