 ...
 * 转拨出单按钮
 */	
Ext.define('erp.view.core.button.BatchTurnAppropriationOut',{ 
		extend: 'Ext.Button', 
		alias: 'widget.erpBatchTurnAppropriationOutButton',
		iconCls: 'x-button-icon-submit',
    	cls: 'x-btn-gray',
    	id: 'erpBatchTurnAppropriationOutButton',
    	text: $I18N.common.button.erpBatchTurnAppropriationOutButton,
    	style: {
    		marginLeft: '10px'
        },
        width: 120,
		...
		handler:function(url){
			...
			if(records.length > 0){
				...
				if(bool){
					...
					Ext.Ajax.request({
				   		url : basePath + 'drp/batchTurnAppropriationOut.action',
				   		params: params,
				   		method : 'post',
				   		timeout: 6000000,
