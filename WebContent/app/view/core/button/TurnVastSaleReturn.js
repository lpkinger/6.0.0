 ...
 * 转退货按钮
 */	
Ext.define('erp.view.core.button.TurnVastSaleReturn',{ 
		extend: 'Ext.Button', 
		alias: 'widget.erpTurnVastSaleReturnButton',
		iconCls: 'x-button-icon-submit',
    	cls: 'x-btn-gray',
    	text: $I18N.common.button.erpTurnVastSaleReturnButton,
    	id:'erpTurnVastSaleReturnButton',
    	style: {
    		marginLeft: '10px'
        },
        width: 100,
		...
		handler:function(url){
			...
			if(records.length > 0){
				...
				if(bool){
					...
					Ext.Ajax.request({
				   		url : basePath + 'drp/vastTurnSaleReturn.action',
				   		params: params,
				   		method : 'post',
				   		timeout: 6000000,
