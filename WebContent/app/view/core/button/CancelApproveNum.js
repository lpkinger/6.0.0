Ext.define('erp.view.core.button.CancelApproveNum',{ 
		extend: 'Ext.Button', 
		alias: 'widget.erpCancelApproveNumButton',
		param: [],
		id: 'erpCancelApproveNumButton',
		text: $I18N.common.button.erpCancelApproveNumButton,
		...
		if(records.length > 0){
			...
			if(bool){
				...
				Ext.Ajax.request({
			   		url : basePath + "oa/cancelApproveNum.action",
			   		params: params,
			   		method : 'post',
