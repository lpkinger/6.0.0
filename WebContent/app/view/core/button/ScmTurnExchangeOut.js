 ...
 * 转换货出库按钮
 */	
Ext.define('erp.view.core.button.ScmTurnExchangeOut',{ 
		extend: 'Ext.Button', 
		alias: 'widget.erpScmTurnExchangeOut',
		iconCls: 'x-button-icon-submit',
    	cls: 'x-btn-gray',
    	id: 'erpScmTurnExchangeOut',
    	text: $I18N.common.button.erpScmTurnExchangeOut,
    	style: {
    		marginLeft: '10px'
        },
        width: 120,
		...
		handler:function(url){
			...
			if(records.length > 0){
				...
				if(bool){
					...
					Ext.Ajax.request({
				   		url : basePath + 'scm/sale/turnProdOut.action?type=ProdInOut!ExchangeOut',
				   		params: params,
				   		method : 'post',
				   		timeout: 6000000,
