 ...
 * 转其它出库按钮
 */	
Ext.define('erp.view.core.button.ScmTurnOtherOut',{ 
		extend: 'Ext.Button', 
		alias: 'widget.erpScmTurnOtherOut',
		iconCls: 'x-button-icon-submit',
    	cls: 'x-btn-gray',
    	id: 'erpScmTurnOtherOut',
    	text: $I18N.common.button.erpScmTurnOtherOut,
    	style: {
    		marginLeft: '10px'
        },
        width: 120,
		...
		handler:function(url){
			...
			if(records.length > 0){
				...
				if(bool){
					...
					Ext.Ajax.request({
				   		url : basePath + 'scm/sale/turnProdOut.action?type=ProdInOut!OtherOut',
				   		params: params,
				   		method : 'post',
				   		timeout: 6000000,
