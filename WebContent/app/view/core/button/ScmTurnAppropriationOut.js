 ...
 * 转拨出库按钮
 */	
Ext.define('erp.view.core.button.ScmTurnAppropriationOut',{ 
		extend: 'Ext.Button', 
		alias: 'widget.erpScmTurnAppropriationOut',
		iconCls: 'x-button-icon-submit',
    	cls: 'x-btn-gray',
    	id: 'erpScmTurnAppropriationOut',
    	text: $I18N.common.button.erpScmTurnAppropriationOut,
    	style: {
    		marginLeft: '10px'
        },
        width: 120,
		...
		handler:function(url){
			...
			if(records.length > 0){
				...
				if(bool){
					...
					Ext.Ajax.request({
				   		url : basePath + 'scm/sale/turnProdOut.action?type=ProdInOut!AppropriationOut',
				   		params: params,
				   		method : 'post',
				   		timeout: 6000000,
