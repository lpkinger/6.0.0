 ...
 * 转采购验退单
 */	
Ext.define('erp.view.core.button.TurnPurcOut',{ 
		extend: 'Ext.Button', 
		alias: 'widget.erpTurnPurcOutButton',
		iconCls: 'x-button-icon-submit',
    	cls: 'x-btn-gray',
    	id:'turnPurcOut',
    	text: $I18N.common.button.erpTurnPurcOutButton,
    	style: {
    		marginLeft: '10px'
        },
        width: 130,
		...
		listeners: {
			...
			click: function(m){
        		Ext.getCmp('turnPurcOut').turn('ProdIN!ToProdPurcOut!Deal', ' pd_piid=' + Ext.getCmp('pi_id').value +' and nvl(pd_yqty,0) < nvl(pd_inqty,0) + nvl(pd_outqty,0)', 'scm/reserve/turnDefectOut.action?type=ProdInOut!PurcCheckout');
        	}
		},
