Ext.define('erp.view.fa.ars.ARBill',{ 
	extend: 'Ext.Viewport', 
	layout: 'anchor', 
	...
	initComponent : function(){ 
		...
		Ext.apply(me, { 
			items: [{
				xtype: 'erpFormPanel',
				anchor: '100% 50%',
				saveUrl: 'fa/ars/saveARBill.action',
				deleteUrl: 'fa/ars/deleteARBill.action',
				updateUrl: 'fa/ars/updateARBill.action',
				auditUrl: 'fa/ars/auditARBill.action',
				resAuditUrl: 'fa/ars/resAuditARBill.action',
				submitUrl: 'fa/ars/submitARBill.action',
				resSubmitUrl: 'fa/ars/resSubmitARBill.action',
				postUrl: 'fa/ars/postARBill.action',
				resPostUrl: 'fa/ars/resPostARBill.action',
				printUrl:'fa/ars/printARBill.action',
				printVoucherCodeUrl: 'fa/ars/printVoucherCodeARBill.action',
				getIdUrl: 'common/getId.action?seq=ARBill_SEQ',
				keyField: 'ab_id',
				codeField: 'ab_code',
	...
	renderColumns: function(gridConfig, cols, headerColor) {
		Ext.Array.each(cols, function(col){
			if(col.xtype=='textareatrigger'){
				col.xtype='';
				col.renderer='texttrigger';
			}
			var logic = col.logic;
			delete col.locked;
