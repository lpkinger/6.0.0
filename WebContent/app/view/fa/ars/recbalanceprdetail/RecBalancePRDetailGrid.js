Ext.define('erp.view.fa.ars.recbalanceprdetail.RecBalancePRDetailGrid',{
	extend:'Ext.grid.Panel',
	alias:'widget.recbalanceprdetail',
	requires:['erp.view.fa.ars.recbalanceprdetail.RBPDtoolbar'],
	layout:'fit',
	id:'recbalanceprdetailGrid',
	...
	initComponent:function(){
		...
		var condition='';
		if(urlCondition){
			condition = urlCondition.replace('rbd_rbid','rbpd_rbid');
	...
	getMyData:function(condition){
		...
		var me = this;
		var caller = (me.caller&&me.caller!='')?me.caller:'RBPDGird';
		var params = {
				caller:caller,
				condition:condition
		};
