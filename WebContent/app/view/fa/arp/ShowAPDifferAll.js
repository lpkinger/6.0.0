 ...
 * 应付对账全部差异
 */
Ext.define('erp.view.fa.arp.ShowAPDifferAll',{ 
	extend: 'Ext.Viewport', 
	alias: 'widget.showapdifferall',
	layout: 'anchor', 
	hideBorders: true, 
	id: 'showapdifferall', 
    ...
    defaultColumns: [{
		...
		dataIndex: 'tb_vendcode',
		cls: 'x-grid-header-1',
		text: '供应商编号',
		width: 120
	},{
		dataIndex: 'tb_vendname',
		cls: 'x-grid-header-1',
		text: '供应商名称',
		width: 250
	},{
