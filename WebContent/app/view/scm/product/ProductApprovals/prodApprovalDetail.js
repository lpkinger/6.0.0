Ext.define('erp.view.scm.product.ProductApprovals.prodApprovalDetail',{ 
	extend: 'Ext.form.Panel', 
	alias: 'widget.prodApprovalDetail',
	id: 'prodApprovalDetail', 
	columnWidth:1, 
	frame : true,
	layout : 'column',
	autoScroll : true,
	...
	labelSeparator : ':',
	buttonAlign : 'center',
	/*tools:[{xtype:'ProdApprovalDetailsaveButton',id:'prodApprovalDetailsave'}],//
*/	fieldDefaults : {
		margin : '2 2 2 2',
