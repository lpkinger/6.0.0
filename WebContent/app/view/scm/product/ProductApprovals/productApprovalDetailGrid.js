 ...
 * ERP项目gridpanel通用样式2
 */
Ext.define('erp.view.scm.product.ProductApprovals.productApprovalDetailGrid',{ 
	extend: 'Ext.grid.Panel', 
	alias: 'widget.productApprovalDetailGrid',
	requires: ['erp.view.core.toolbar.Toolbar'],
	region: 'south',
	layout : 'fit',
	id: 'productApprovalDetailGrid', 
    ...
    bbar: {xtype: 'erpToolbar',id:'productApprovalDetailGridbar'},
