Ext.define('erp.view.scm.reserve.profitBarcode.GridPanel',{ 
	extend: 'Ext.grid.Panel', 
	alias: 'widget.erpProfitBarcodeGridPanel',
	requires: ['erp.view.core.grid.HeaderFilter', 'erp.view.core.toolbar.Toolbar', 'erp.view.core.plugin.CopyPasteMenu'],
	id: 'profitBarcodeGridPanel', 
	needField:'bi_vendbarcode',
	needField2:'bi_madedate',
	needField3:'bi_location',
	needField4:'pr_boxqty',
    ...
    selModel: Ext.create('Ext.selection.CheckboxModel',{
	        ...
	        onHeaderClick: function(headerCt, header, e) {
	            ...
	            Ext.getCmp('profitBarcodeGridPanel').summary();
	        }
	}),
	tbar:['->',{
			xtype:'combobox',
