...
Ext.application({
    ...
    controllers: [//声明所用到的控制层
        'fa.ars.ShowCmCopDetail'
    ],
    launch: function() {
    	Ext.create('erp.view.fa.ars.cmCopQuery.ShowCmDetail');//创建视图
    }
});
/* var caller = '${param.whoami}'; */
var showtype = getUrlParam('showtype');
var cmid = getUrlParam('cmid');
var yearmonth = getUrlParam('yearmonth');
var currency = getUrlParam('currency');
var cop = getUrlParam('cop');
var custcode = getUrlParam('custcode');
var custname = getUrlParam('custname');//+'&chkumio='+me.chkumio
