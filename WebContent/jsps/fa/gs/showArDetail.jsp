...
Ext.application({
    ...
    launch: function() {
    	Ext.create('erp.view.fa.gs.arQuery.ShowArDetail');//创建视图
    }
});
/* var caller = '${param.whoami}'; */
var showtype = getUrlParam('showtype');
var amid = getUrlParam('amid');
var yearmonth = getUrlParam('yearmonth');
var currency = getUrlParam('currency');
var accountcode = getUrlParam('accountcode');
var accountname = getUrlParam('accountname');
</script>
</head>
<body >
</body>
