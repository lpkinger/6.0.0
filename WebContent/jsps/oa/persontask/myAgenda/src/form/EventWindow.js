	...
	requires: [
	           ...
	           constructor: function(config) {
	        	   ...
	        	   this.callParent([Ext.apply({
	        		   ...
	        		   buttonAlign: 'left',
	        		   savingMessage: '保存修改',
	        		   deletingMessage: '删除任务',
	        		   layout: 'fit',    
	        		   fbar: [{
	        			   xtype: 'tbtext',
	        			   text: '<a href="#" id="tblink">查看关联信息</a>'
	        		   },
	        		   '->',
	        		   {
	        			   itemId: 'delete-btn',
	           ...
	           onEditDetailsClick: function(e){
	        	/*   e.stopEvent();
	        	   ...
	        	   if(this.activeRecord.get('Url')){
	        		   openUrl(this.activeRecord.get('Url'));
	        	   }else if(caller=='ExpandPlan'){
	        		   var mid=getUrlParam('mid');
	        		   openUrl('jsps/crm/customermgr/customervisit/expandPlan.jsp?formCondition=ep_idIS'+mid+'&gridCondition=epd_epidIS'+mid);
	        	   }
