...
Ext.application({
    ...
    controllers: [//声明所用到的控制层
        'oa.officialDocument.fileManagement.DocumentRoom'
    ],
    launch: function() {
    	Ext.create('erp.view.oa.officialDocument.fileManagement.documentRoom.DocumentRoom');//创建视图
    }
});
var page = 1;
