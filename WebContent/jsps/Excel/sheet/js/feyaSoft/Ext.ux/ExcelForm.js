Ext.form.ExcelForm=Ext.extend(Ext.form.FormPanel,{ 
	id: 'excelform', 
    region: 'center',
    frame : true,
	layout : 'column',
...
Ext.reg('erpExcelFormPanel', Ext.form.ExcelForm);