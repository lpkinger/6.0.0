...
Ext.application({
    ...
    appFolder: basePath + 'app',//app文件夹所在路径
		...
		launch : function() {
			Ext.create('erp.view.hr.wage.calc.Wagecalculate');//创建视图
		}
	});
	//var caller = 'Wagecalculate';
</script>
</head>
<body>
	<ul id="desc">
		<li><img src="<%=basePath%>resource/images/renderer/remind.png"/>工资报表计算需要进行大量数据计算，请不要频繁点击!</li>
