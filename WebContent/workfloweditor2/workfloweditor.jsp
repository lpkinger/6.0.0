...
Ext.BLANK_IMAGE_URL = 'scripts/ext-2.0.2/resources/images/default/s.gif';
    ...
    var fd_name = getUrlParam('fd_name');//flow_define
    var fd_id = getUrlParam('fd_id');//flow_define
    var caller = getUrlParam('caller');//flow_define
    var shortName = getUrlParam('shortName');//flow_define
    var allNode = new Array();//收集所有node
    var allConnection = new Array();//收集所有operation
