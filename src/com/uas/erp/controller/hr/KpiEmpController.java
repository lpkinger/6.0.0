...
@Controller
public class KpiEmpController {
	@Autowired
	private KpiEmpService kpiEmpService;
	@Autowired
	private SingleGridPanelService singleGridPanelService;
	
	@RequestMapping(value = "/hr/kpi/saveKpiEmp.action")
	@ResponseBody
	public Map<String, Object> save(String formStore,String param,String caller){
		Map<String, Object> modelMap = new HashMap<String, Object>();
		kpiEmpService.saveKpiEmp(formStore, param,caller);
		modelMap.put("success", true);
		return modelMap;
	}
	@RequestMapping(value = "/hr/kpi/singleGridPanel2.action")
	@ResponseBody
	public Map<String, Object> getGridFields(String caller, String condition) {
		...
		modelMap.put("data", kpiEmpService.show(gridPanel.getDataString(), condition));
		return modelMap;
	}
}
