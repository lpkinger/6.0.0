...
import com.uas.erp.core.XlsxAbstract;
...
/**
 * 初始化导入excel， 支持大数量excel, 支持excel07
 * @author lidy
 */
public class InitImportXlsx extends XlsxAbstract {
	...
	public InitImportXlsx(InputStream is, String caller) throws Exception {
		super(is);
