...
@Service
public class SocailSecurityServiceImpl implements SocailSecurityService {
	
	static final String updateSEmpl = " update employee set EM_ENDINSU='是',EM_MEDINSU='是'," +
			"EM_UNEMPINSU='是',EM_EMINJUINSU='是',EM_MATEINSU='是',EM_SOCAILCARD=? where em_id=?";
	...
	@Override
	public void saveSocailSecurity(String formStore, String caller) {
	...
	@Override
	public void updateSocailSecurityById(String formStore, String caller) {
		Map<Object, Object> store = BaseUtil.parseFormStoreToMap(formStore);
	...
	@Override
	public void deleteSocailSecurity(int em_id, String caller) {
		//执行删除前的其它逻辑
	...
	@Override
	public void vastSocailsecu(	String caller, String[] mark, int[] id) {
		String emAccumucard;
		int idValue;
		try {
