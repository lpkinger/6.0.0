...
@Service
public class ProdioutlinServiceImpl implements ProdioutlinService {
	...
	@Override
	public void saveProdioutlin(String formStore, String gridStore,
			String caller) {
	...
	@Override
	public void updateProdioutlinById(String formStore, String gridStore,
			String caller) {
		Map<Object, Object> store = BaseUtil.parseFormStoreToMap(formStore);
	...
	@Override
	public void deleteProdioutlin(int pi_id, String caller) {
		// 执行删除前的其它逻辑
	...
	@Override
	public void auditProdioutlin(int pi_id, String caller) {
	...
	@Override
	public void resAuditProdioutlin(int pi_id, String caller) {
		Object status = baseDao.getFieldDataByCondition("prodinout",
				"pi_statuscode", "pi_id=" + pi_id);
	...
	@Override
	public void submitProdioutlin(int pi_id, String caller) {
	...
	@Override
	public void resSubmitProdioutlin(int pi_id, String caller) {
