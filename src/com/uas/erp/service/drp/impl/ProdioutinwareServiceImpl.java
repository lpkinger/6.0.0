...
@Service
public class ProdioutinwareServiceImpl implements ProdioutinwareService {
	...
	@Override
	public void saveProdioutinware(String formStore, String gridStore, String caller) {
		List<Map<Object, Object>> grid = BaseUtil.parseGridStoreToMaps(gridStore);
		Map<Object, Object> store = BaseUtil.parseFormStoreToMap(formStore);
		handlerService.beforeSave(caller, new Object[] { store, grid });
		String formSql = SqlUtil.getInsertSqlByFormStore(store, "prodinout", new String[] {}, new Object[] {});
	...
	@Override
	public void updateProdioutinwareById(String formStore, String gridStore, String caller) {
		...
		baseDao.execute(formSql);
		// 修改purchaseDetail
		List<String> gridSql = SqlUtil.getUpdateSqlbyGridStore(gridStore, "prodiodetail", "pd_id");
		for (Map<Object, Object> s : gstore) {
			if (s.get("pd_id") == null || s.get("pd_id").equals("") || s.get("pd_id").toString().equals("0")) {// 新添加的数据，id不存在
				...
				String sql = SqlUtil.getInsertSqlByMap(s, "prodiodetail", new String[] { "pd_id" }, new Object[] { id });
				gridSql.add(sql);
			}
		}
		baseDao.execute(gridSql);
	...
	@Override
	public void deleteProdioutinware(int pi_id, String caller) {
		// 执行删除前的其它逻辑
	...
	@Override
	public void auditProdioutinware(int pi_id, String caller) {
		...
		// 执行审核操作
		baseDao.updateByCondition("prodinout", "pi_statuscode='AUDITED',pi_status='" + BaseUtil.getLocalMessage("AUDITED")
				+ "',PI_AUDITMAN='" + SystemSession.getUser().getEm_name() + "',PI_AUDITDATE=sysdate", "pi_id=" + pi_id);
		// 记录操作
	...
	@Override
	public void resAuditProdioutinware(int pi_id, String caller) {

		Object status = baseDao.getFieldDataByCondition("prodinout", "pi_statuscode", "pi_id=" + pi_id);
		StateAssert.resAuditOnlyAudit(status);
		handlerService.beforeResAudit(caller, pi_id);
		// 执行反审核操作
		baseDao.updateByCondition("prodinout", "pi_statuscode='ENTERING',pi_status='" + BaseUtil.getLocalMessage("ENTERING")
				+ "',PI_AUDITMAN='',PI_AUDITDATE=null", "pi_id=" + pi_id);
		// 记录操作
	...
	@Override
	public void submitProdioutinware(int pi_id, String caller) {
		...
		// 执行提交操作
		baseDao.updateByCondition("prodinout", "pi_statuscode='COMMITED',pi_status='" + BaseUtil.getLocalMessage("COMMITED") + "'",
				"pi_id=" + pi_id);
		// 记录操作
	...
	@Override
	public void resSubmitProdioutinware(int pi_id, String caller) {
