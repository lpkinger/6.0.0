...
@Service
public class ProdioutfaServiceImpl implements ProdioutfaService {
	...
	@Override
	public void saveProdioutfa(String formStore, String gridStore, String caller) {
		List<Map<Object, Object>> grid = BaseUtil
				.parseGridStoreToMaps(gridStore);
		Map<Object, Object> store = BaseUtil.parseFormStoreToMap(formStore);
		handlerService.beforeSave(caller, new Object[] { store, grid });
		String formSql = SqlUtil.getInsertSqlByFormStore(store, "prodinout",
	...
	@Override
	public void updateProdioutfaById(String formStore, String gridStore,
			String caller) {
		...
		// 修改purchase
		String formSql = SqlUtil.getUpdateSqlByFormStore(store, "prodinout",
				"pi_id");
		baseDao.execute(formSql);
		// 修改purchaseDetail
	...
	@Override
	public void deleteProdioutfa(int pi_id, String caller) {
	...
	@Override
	public void auditProdioutfa(int pi_id, String caller) {
	...
	@Override
	public void resAuditProdioutfa(int pi_id, String caller) {
		...
		baseDao.updateByCondition(
				...
				"pi_statuscode='ENTERING',pi_status='"
						...
						+ "',PI_AUDITDMAN='',PI_AUDITDATE=null", "pi_id="
						+ pi_id);
		// 记录操作
	...
	@Override
	public void submitProdioutfa(int pi_id, String caller) {
	...
	@Override
	public void resSubmitProdioutfa(int pi_id, String caller) {
