...
@Service
public class ReservelinServiceImpl implements ReservelinService {
	...
	@Override
	public void saveReservelin(String formStore, String gridStore, String caller) {
	...
	@Override
	public void updateReservelinById(String formStore, String gridStore,
			String caller) {
	...
	@Override
	public void deleteReservelin(int pi_id, String caller) {
	...
	@Override
	public void auditReservelin(int pi_id, String caller) {

		// 只能对状态为[已提交]的订单进行审核操作!
		Object status = baseDao.getFieldDataByCondition("prodinout",
				"pi_invostatuscode", "pi_id=" + pi_id);
		...
		baseDao.updateByCondition(
				"prodinout",
				"pi_invostatuscode='AUDITED',pi_invostatus='"
	...
	@Override
	public void resAuditReservelin(int pi_id, String caller) {
		...
		baseDao.updateByCondition(
				"prodinout",
				"pi_invostatuscode='ENTERING',pi_invostatus='"
	...
	@Override
	public void submitReservelin(int pi_id, String caller) {
		...
		baseDao.updateByCondition(
				"prodinout",
				"pi_invostatuscode='COMMITED',pi_invostatus='"
	...
	@Override
	public void resSubmitReservelin(int pi_id, String caller) {
