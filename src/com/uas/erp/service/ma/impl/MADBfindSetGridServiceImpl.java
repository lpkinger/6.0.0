...
@Service
public class MADBfindSetGridServiceImpl implements MADBfindSetGridService{
	@Autowired
	private BaseDao baseDao;
	@Override
	public void save(String form, String formdetail) {
		String formSql = SqlUtil.getInsertSqlByFormStore(form, "DBfindSetGrid", new String[]{}, new Object[]{});
