...
public interface CustomerBaseService {
	...
	void updateCustomerCreditSet(String formStore, String caller);
	...
	void submitHandleHangCustomerBase(int id, String caller);
	void HandleHangCustomerBase(int id, String caller); 
	String getCustomerKindNum(String cu_kind);
	void hungCustomer(int id, String caller);
	void reHungCustomer(int id, String caller);
	void regB2BCustomer(int id);
}
