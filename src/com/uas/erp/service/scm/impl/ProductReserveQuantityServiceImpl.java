...
@Service
public class ProductReserveQuantityServiceImpl implements ProductReserveQuantityService{
	@Autowired
	...
	public void updateProductWHById(String formStore, String caller) {
		...
		//执行修改前的其它逻辑
		handlerService.handler("Product!ReserveQuantity", "save", "before", new Object[]{store});
		//修改
		...
		//执行修改后的其它逻辑
		handlerService.handler("Product!ReserveQuantity", "save", "after", new Object[]{store});
	}
}
