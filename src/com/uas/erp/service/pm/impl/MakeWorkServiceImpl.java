...
@Service("makeWorkService")
public class MakeWorkServiceImpl implements MakeWorkService{
	@Autowired
	private BaseDao baseDao;
	@Autowired
	private HandlerService handlerService;
	@Override
	public void saveMakeWork(String formStore, String caller) {
	...
	@Override
	public void deleteMakeWork(int ma_id, String caller) {
		//只能删除在录入的单据!
	...
	@Override
	public void updateMakeWorkById(String formStore, String caller) {
		Map<Object, Object> store = BaseUtil.parseFormStoreToMap(formStore);
		//只能修改[在录入]的资料!
	...
	@Override
	public void auditMakeWork(int ma_id, String caller) {
		...
		//执行审核操作
		baseDao.audit("Make", "ma_id=" + ma_id, "ma_checkstatus", "ma_checkstatuscode","ma_auditdata","ma_auditman");
		//记录操作
	...
	@Override
	public void resAuditMakeWork(int ma_id, String caller) {
		//只能对状态为[已审核]的订单进行反审核操作!
		Object status = baseDao.getFieldDataByCondition("Make", "ma_statuscode", "ma_id=" + ma_id);
		StateAssert.resAuditOnlyAudit(status);
		//执行反审核操作
		baseDao.resOperate("Make", "ma_id=" + ma_id, "ma_checkstatus", "ma_checkstatuscode");
		//记录操作
		baseDao.logger.resAudit(caller, "ma_id", ma_id);
	}
	
	@Override
	public void submitMakeWork(int ma_id, String caller) {
	...
	@Override
	public void resSubmitMakeWork(int ma_id, String caller) {
