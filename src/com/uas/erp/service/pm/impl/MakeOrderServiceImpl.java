...
public class MakeOrderServiceImpl implements MakeOrderService{
	...
	@Override
	public void saveMakeOrder(String formStore, String caller) {
	...
	@Override
	public void deleteMakeOrder(int ma_id, String caller) {
		//只能删除在录入的单据!
	...
	@Override
	public void updateMakeOrderById(String formStore, String caller) {
		Map<Object, Object> store = BaseUtil.parseFormStoreToMap(formStore);
		//只能修改[在录入]的资料!
	...
	@Override
	public void auditMakeOrder(int ma_id, String caller) {
	...
	@Override
	public void resAuditMakeOrder(int ma_id, String caller) {
	...
	@Override
	public void submitMakeOrder(int ma_id, String caller) {
	...
	@Override
	public void resSubmitMakeOrder(int ma_id, String caller) {
