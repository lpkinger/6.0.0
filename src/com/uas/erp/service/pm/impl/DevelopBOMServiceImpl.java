...
public class DevelopBOMServiceImpl implements DevelopBOMService{
	@Autowired
	...
	@Override
	public void saveDevelopBOM(String formStore, String gridStore, String caller) {
		...
		//执行保存前的其它逻辑
		handlerService.beforeSave("BOM", new Object[]{store,gstore});		//保存
	...
	@Override
	public void deleteDevelopBOM(int bo_id, String caller) {
		//只能删除在录入的采购单!
		Object status = baseDao.getFieldDataByCondition("BOM", "bo_statuscode", "bo_id=" + bo_id);
		StateAssert.delOnlyEntering(status);
		//执行删除前的其它逻辑
		handlerService.beforeDel("BOM", new Object[]{bo_id});		//删除
	...
	@Override
	public void updateDevelopBOMById(String formStore, String gridStore, String caller) {
		Map<Object, Object> store = BaseUtil.parseFormStoreToMap(formStore);
		List<Map<Object, Object>> gstore = BaseUtil.parseGridStoreToMaps(gridStore);
		//只能修改[在录入]的采购单资料!
		...
		//执行修改前的其它逻辑
		handlerService.beforeSave("BOM", new Object[]{store,gstore});		//修改
	...
	@Override
	public void auditDevelopBOM(int bo_id, String caller) {
		//只能对状态为[已提交]的订单进行审核操作!
		Object status = baseDao.getFieldDataByCondition("BOM", "bo_statuscode", "bo_id=" + bo_id);
		StateAssert.auditOnlyCommited(status);
		//执行审核前的其它逻辑
		handlerService.beforeAudit("BOM", new Object[]{bo_id});		//执行审核操作
	...
	@Override
	public void resAuditDevelopBOM(int bo_id, String caller) {
	...
	@Override
	public void submitDevelopBOM(int bo_id, String caller) {
		//只能对状态为[在录入]的订单进行提交操作!
		Object status = baseDao.getFieldDataByCondition("BOM", "bo_statuscode", "bo_id=" + bo_id);
		StateAssert.submitOnlyEntering(status);
		//执行提交前的其它逻辑
		handlerService.beforeSubmit("BOM",new Object[]{bo_id});		//执行提交操作
	...
	@Override
	public void resSubmitDevelopBOM(int bo_id, String caller) {
