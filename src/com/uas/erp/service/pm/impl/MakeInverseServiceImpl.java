...
@Service("makeInverseService")
public class MakeInverseServiceImpl implements MakeInverseService{
	@Autowired
	private BaseDao baseDao;
	@Autowired
	private HandlerService handlerService;
	@Override
	public void saveMakeInverse(String formStore, String caller) {
	...
	@Override
	public void deleteMakeInverse(int ma_id, String caller) {
		//只能删除在录入的单据!
	...
	@Override
	public void updateMakeInverseById(String formStore, String caller) {
		Map<Object, Object> store = BaseUtil.parseFormStoreToMap(formStore);
		//只能修改[在录入]的资料!
		Object status = baseDao.getFieldDataByCondition("Make", "ma_statuscode", "ma_id" + store.get("ma_id"));
		StateAssert.updateOnlyEntering(status);
		//执行修改前的其它逻辑
		handlerService.beforeUpdate(caller, new Object[]{store});		//修改
	...
	@Override
	public void auditMakeInverse(int ma_id, String caller) {
	...
	@Override
	public void resAuditMakeInverse(int ma_id, String caller) {
	...
	@Override
	public void submitMakeInverse(int ma_id, String caller) {
	...
	@Override
	public void resSubmitMakeInverse(int ma_id, String caller) {
