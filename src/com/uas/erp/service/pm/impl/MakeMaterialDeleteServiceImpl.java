...
@Service("makeMaterialDeleteService")
public class MakeMaterialDeleteServiceImpl implements MakeMaterialDeleteService{
	@Autowired
	private BaseDao baseDao;
	@Autowired
	private HandlerService handlerService;
	@Override
	public void saveMakeMaterialDelete(String formStore, String caller) {
	...
	@Override
	public void deleteMakeMaterialDelete(int mm_id, String caller) {
		//只能删除在录入的单据!
	...
	@Override
	public void updateMakeMaterialDeleteById(String formStore, String caller) {
		Map<Object, Object> store = BaseUtil.parseFormStoreToMap(formStore);
		//只能修改[在录入]的资料!
	...
	@Override
	public void auditMakeMaterialDelete(int mm_id, String caller) {
		//只能对状态为[已提交]的订单进行审核操作!
		Object status = baseDao.getFieldDataByCondition("MakeMaterial", "mm_statuscode", "mm_id=" + mm_id);
		StateAssert.auditOnlyCommited(status);
		//执行审核前的其它逻辑
		handlerService.beforeAudit(caller, new Object[]{mm_id});		//执行审核操作
		baseDao.audit("MakeMaterial", "mm_id=" + mm_id, "mm_status", "mm_statuscode", "mm_auditdate", "mm_auditman");
		//记录操作
	...
	@Override
	public void resAuditMakeMaterialDelete(int mm_id, String caller) {
		//只能对状态为[已审核]的订单进行反审核操作!
		Object status = baseDao.getFieldDataByCondition("MakeMaterial", "mm_statuscode", "mm_id=" + mm_id);
		StateAssert.resAuditOnlyAudit(status);
		handlerService.beforeResAudit(caller, new Object[]{mm_id});
		//执行反审核操作
	...
	@Override
	public void submitMakeMaterialDelete(int mm_id, String caller) {
		...
		//执行提交操作
		baseDao.updateByCondition("MakeMaterial", "mm_statuscode='COMMITED',mm_status='" + 
				BaseUtil.getLocalMessage("COMMITED") + "'", "mm_id=" + mm_id);
		//记录操作
	...
	@Override
	public void resSubmitMakeMaterialDelete(int mm_id, String caller) {
