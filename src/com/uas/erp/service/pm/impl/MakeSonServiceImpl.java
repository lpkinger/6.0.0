...
@Service("makeSonService")
public class MakeSonServiceImpl implements MakeSonService{
	@Autowired
	private BaseDao baseDao;
	@Autowired
	private HandlerService handlerService;
	@Override
	public void saveMakeSon(String formStore, String caller) {
	...
	@Override
	public void deleteMakeSon(int ma_id, String caller) {
		//只能删除在录入的单据!
	...
	@Override
	public void updateMakeSonById(String formStore, String caller) {
		Map<Object, Object> store = BaseUtil.parseFormStoreToMap(formStore);
		//只能修改[在录入]的资料!
	...
	@Override
	public void auditMakeSon(int ma_id, String caller) {
	...
	@Override
	public void resAuditMakeSon(int ma_id, String caller) {
	...
	@Override
	public void submitMakeSon(int ma_id, String caller) {
	...
	@Override
	public void resSubmitMakeSon(int ma_id, String caller) {
