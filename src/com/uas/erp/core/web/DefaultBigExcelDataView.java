 ...
 *
 */
public class DefaultBigExcelDataView extends AbstractDataView<Row> {

	public DefaultBigExcelDataView(DocumentConfig config, List<Map<String, Object>> datas) {
		super(config, datas);
		setContentType("application/vnd.ms-excel");
		setExtension(".xlsx");
	}

	public DefaultBigExcelDataView(DocumentConfig config, List<Map<String, Object>> datas, String fileName) {
		this(config, datas);
