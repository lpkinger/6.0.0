 ...
 */
public class PositionPower implements Saveable, Serializable {
	...
	public int getPp_joid() {
		return pp_joid;
	}

	public void setPp_joid(int pp_joid) {
		this.pp_joid = pp_joid;
	}
