...
public class JProCand implements Serializable {
	/**
	 * 
	 */
	...
	public String getJp_candidate() {
		return jp_candidate;
	}

	public void setJp_candidate(String jp_candidate) {
		this.jp_candidate = jp_candidate;
	}
