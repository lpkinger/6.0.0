 ...
 *
 */
public class RolePower implements Saveable, Serializable {
	...
	public int getRp_roid() {
		return rp_roid;
	}

	public void setRp_roid(int rp_roid) {
		this.rp_roid = rp_roid;
	}
