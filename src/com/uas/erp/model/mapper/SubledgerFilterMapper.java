...
@Component
public class SubledgerFilterMapper extends SqlParameterMapper<LedgerFilter, Struct> {

	private static final String IN_TYPE_NAME = "UAS_ORA_SUBLEDGER_FILTER";
	private static final String OUT_TYPE_NAME = "UAS_ORA_SUBLEDGER_RESULT";
	...
	protected Struct createSqlValue(Connection con, final LedgerFilter filter) throws SQLException {
		...
		Object[] c = new Object[] { filter.getSl_yearmonth().getBegin(), filter.getSl_yearmonth().getEnd(), filter.getSl_date().getBegin(),
				filter.getSl_date().getEnd(), filter.getCa_level().getBegin(),
				...
				// cate_name_last
				null, filter.getVds_asscode().getAsl_asstype(),
