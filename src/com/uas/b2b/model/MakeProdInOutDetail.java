 ...
 *
 */
public class MakeProdInOutDetail {

	private Long pd_id;//id
	private Short pd_detno;//明细行序号
	private String pd_ordercode;//委外编号 1
	private Short pd_orderdetno;//采购单明细行号
	private Double pd_inqty;//入库数量 1
	private Double pd_outqty;//出库数量 1
	private Double pd_orderprice;//委外加工单价 1
	private Double pd_taxrate;//税率 1
	private String pd_batchcode;//批号 1
	private String pd_remark;//备注 1
