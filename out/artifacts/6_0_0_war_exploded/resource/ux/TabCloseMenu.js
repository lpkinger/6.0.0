...
Ext.define('Ext.tab.TabCloseMenu', {
    ...
    showCloseRights:true,
    
    closeRightsTabsText:'Close Rights Tabs',
    ...
    onContextMenu : function(event, target){
        ...
        if (me.showCloseAll || me.showCloseOthers || me.showCloseRights) {
            me.tabPanel.items.each(function(item,ind) {
                if (item.closable) {
                    disableAll = false;
                    if (item != me.item) {
                        disableOthers = false;       
            ...
            if(me.showCloseRights){
            	 menu.child('*[text="' + me.closeRightsTabsText + '"]').setDisabled(disableRights);
            }
        }
        /*close right*/
    ...
    createMenu : function() {
        ...
        if (!me.menu) {
            ...
            items.push({
            	text: me.closeRightsTabsText,
                scope: me,
                handler: me.onCloseRights
            });
            if (me.showCloseAll) {
                items.push({
    ...
    onCloseRights:function(){
    	  var items = [];
    	  var currentIndex=this.currentIndex;
    	  this.tabPanel.items.each(function(item,index){
              if(item.closable && index>currentIndex){
                 items.push(item);
              }
          }, this);
