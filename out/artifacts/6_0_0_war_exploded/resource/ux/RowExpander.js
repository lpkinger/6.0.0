...
Ext.define('Ext.ux.RowExpander', {
    ...
    constructor: function() {
        ...
        // just return it back!
        var rowBodyTpl = this.rowBodyTpl.isTemplate ? this.rowBodyTpl : new Ext.XTemplate(this.rowBodyTpl),
            features = [{
                ftype: 'rowbody',
    ...
    bindView: function() {
        ...
        if (!view.rendered) {
	        ...
	        view.on('togglerow', this.onToggle, this);            
        ...
        var me = this;
        if(me.startExpand) {
        	me.getCmp().store.each(function(record){
    ...
    toggleRow: function(rowIdx) {
		...
		this.view.fireEvent('togglerow', rowNode, record, nextBd.dom);
    ...
    getHeaderConfig: function() {
        ...
        return {
            ...
            renderer: me.renderer || function(value, metadata) {
            	if(metadata)
