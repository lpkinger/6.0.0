Ext.define('erp.view.pm.mps.DeskProductGridPanel7',{ 
	extend: 'Ext.grid.Panel', 
	requires: ['erp.view.core.plugin.CopyPasteMenu'],
	alias: 'widget.DeskProductGridPanel7',
        	...
        	callback : function(options,success,response){
        		...
        		var data = res.data != null ? Ext.decode(res.data.replace(/,}/g, '}').replace(/,]/g, ']')) : [];//一定要去掉多余逗号，ie对此很敏感        		
        			...
        			if(me.columns && me.columns.length > 2){
            			...
            			Ext.getCmp('pagingtoolbar7').afterOnLoad();
            		}else {
	                    ...
	                    Ext.Array.each(res.columns, function(column, y) {	                    	
            			 ...
            			 Ext.getCmp('grid7').reconfigure(store, res.columns);
            		}            	  
            	   Ext.getCmp('pagingtoolbar7').afterOnLoad();
            	   Ext.Ajax.request({//拿到grid的columns
