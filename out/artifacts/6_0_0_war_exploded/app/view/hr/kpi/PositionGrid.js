Ext.define('erp.view.hr.kpi.PositionGrid',{ 
	extend: 'Ext.grid.Panel', 
	alias: 'widget.erpPositionGrid',
	id: 'positionGrid', 
    columnLines : true,
    autoScroll : true,
    store: [],
    ...
    initComponent : function(){
    	var gridParam = {caller: this.caller || caller, condition: "kp_positionid=0"};
        this.getGridColumnsAndStore(this, 'hr/kpi/singleGridPanel.action', gridParam, "");//从后台拿到gridpanel的配置及数据
