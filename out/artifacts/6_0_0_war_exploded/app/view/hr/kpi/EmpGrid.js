Ext.define('erp.view.hr.kpi.EmpGrid',{ 
	extend: 'Ext.grid.Panel', 
	alias: 'widget.erpEmpGrid',
	id: 'empGrid', 
    columnLines : true,
    autoScroll : true,
    store: [],
    ...
    initComponent : function(){
    	var gridParam = {caller: this.caller || caller, condition: "ke_emid=0"};
        this.getGridColumnsAndStore(this, 'hr/kpi/singleGridPanel2.action', gridParam, "");//从后台拿到gridpanel的配置及数据
