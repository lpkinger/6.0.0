Ext.define('erp.view.crm.chance.ShowFunnel.GridPanel',{ 
	extend: 'Ext.grid.Panel', 
	alias: 'widget.erpShowFunnelGridPanel',
	id: 'crmquerygrid', 
 	emptyText : '无数据',
    columnLines : true,
    autoScroll : true,
	...
	initComponent : function(){ 
		...
		var gridParam = {caller: "Chance!CRM!Query", condition: condition};
	...
	listeners: {
        ...
        'afterrender':function(){
        	...
        	normalGrid.addListener('itemclick',function(grid,record){
            	if(Number(record.data.ch_id)>0){
                	me.FormUtil.onAdd('showChance'+record.data.ch_id, "查看商机("+record.data.ch_id+")", 'jsps/crm/chance/chance.jsp?formCondition=ch_idIS'+record.data.ch_id);
        		}
