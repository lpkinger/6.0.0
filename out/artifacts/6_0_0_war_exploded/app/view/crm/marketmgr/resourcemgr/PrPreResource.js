Ext.define('erp.view.crm.marketmgr.resourcemgr.PrPreResource',{ 
	extend: 'Ext.Viewport', 
	layout: 'fit', 
	hideBorders: true, 
		...
		Ext.apply(me, { 
			items: [{ 
				...
				items: [{
					...
					auditUrl: 'crm/auditPrPreResource.action?caller='+caller,
					resAuditUrl: 'crm/resAuditPrPreResource.action?caller='+caller,
