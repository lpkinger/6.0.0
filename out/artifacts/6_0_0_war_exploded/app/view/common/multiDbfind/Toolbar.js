		Ext.define('erp.view.common.multiDbfind.Toolbar', {
		    ...
		    doRefresh:function(){
		    	...
		    	resgrid.selectObject=new Object();
		    	this.moveFirst(true);
		    ...
		    updateInfo : function(){
                 ...
                 dataCount, msg;
	                if (displayItem) {
	                    ...
	                    //修改表头全选checkbox选中状态
	                    var hd_checker = Ext.getCmp("dbfindGridPanel").getEl().select('div.x-column-header-checkbox');
		            ...
		            if (k == e.RETURN) {
		                ...
		                if (pageNum !== false) {
		                    ...
		                    if(me.fireEvent('beforechange', me, pageNum) !== false){
		                    	page = pageNum;
		                    	Ext.getCmp("dbfindGridPanel").getColumnsAndStore(caller, condition, page, pageSize);
		                    }
		        ...
		        moveFirst : function(){
	                ...
	                value=1;
	            	page = value;
	            	Ext.getCmp("dbfindGridPanel").headerfilter=true;//不出发grid取消全选
	            	Ext.getCmp("dbfindGridPanel").getColumnsAndStore(caller, condition, page, pageSize);
	                me.updateInfo();
	            	fn(me,value);
	            },
	            movePrevious : function(){
	            	...
	            	page = value;
	            	Ext.getCmp("dbfindGridPanel").headerfilter=true;
	            	Ext.getCmp("dbfindGridPanel").getColumnsAndStore(caller, condition, page, pageSize);
	                me.updateInfo();
	                fn(me,value);
				...
				afterOnLoad : function() {
				    ...
				    if(Ext.getCmp("dbfindGridPanel").noCount) {
				    	var m = e.down('#more');
				    	if(!m) {
				    		m = Ext.create('Ext.panel.Tool', {
								...
								margin: '0 5 0 5',
								handler: function() {
									Ext.getCmp("dbfindGridPanel").getCount(null, null, true);
									m.hide();
									Ext.getCmp("dbfindGridPanel").noCount = false;
								}
				    		});
				    		e.add(m);
				    	} else {
