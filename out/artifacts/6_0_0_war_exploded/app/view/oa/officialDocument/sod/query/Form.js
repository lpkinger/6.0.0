Ext.define('erp.view.oa.officialDocument.sod.query.Form',{ 
	extend: 'Ext.form.Panel', 
	alias: 'widget.erpSODQueryFormPanel',
	id: 'form', 
    region: 'north',
    frame : true,
	layout : 'column',
	...
	tbar: [{
    	...
    	handler: function(){
			...
			if(condition != ''){
				grid.getCount('SendOfficialDocument!Query', condition);
//				url = "oa/officialDocument/instruction/search.action";
