Ext.define('erp.view.scm.reserve.profit.GridPanel',{ 
	extend: 'Ext.grid.Panel', 
	alias: 'widget.erpProfitGridPanel',
    ...
    selModel: Ext.create('Ext.selection.CheckboxModel',{
	        ...
	        onHeaderClick: function(headerCt, header, e) {
	            ...
	            Ext.getCmp('profitGridPanel').summary();
	        }
	}),
	tbar:['->',
	      {
		  ...
		  xtype:'erpPrintBarcodeButton'
	  },{
		  xtype:'erpPrintOutboxcodeButton'
	  },{
