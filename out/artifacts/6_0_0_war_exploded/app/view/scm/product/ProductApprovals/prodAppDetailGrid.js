 ...
 * ERP项目gridpanel通用样式2
 */
Ext.define('erp.view.scm.product.ProductApprovals.prodAppDetailGrid',{ 
	extend: 'Ext.grid.Panel', 
	alias: 'widget.prodAppDetailGrid',
	requires: ['erp.view.core.toolbar.Toolbar'],
	region: 'south',
	layout : 'fit',
	id: 'prodAppDetailGrid', 
    ...
    bbar: {xtype: 'erpToolbar',id:'prodAppDetailGridbar'},
