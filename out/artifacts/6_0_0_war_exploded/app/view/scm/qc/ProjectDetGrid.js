Ext.define('erp.view.scm.qc.ProjectDetGrid',{
	extend:'Ext.grid.Panel',
	alias:'widget.projectdet',
    ...
    bbar: {xtype: 'erpToolbar',id: 'projectdettool'},
	...
	initComponent:function(){
		...
		var condition='';
		if(urlCondition){
			condition = urlCondition.replace('ved_veid','vd_veid');
	...
	getMyData:function(condition){
		var me = this;
		var caller = (me.caller&&me.caller!='')?me.caller:'ProjectDet';
		var params = {
				caller:caller,
				condition:condition
		};
