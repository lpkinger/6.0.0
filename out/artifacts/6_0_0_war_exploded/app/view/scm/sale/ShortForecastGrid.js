Ext.define('erp.view.scm.sale.ShortForecastGrid',{ 
	extend: 'Ext.grid.Panel', 
	alias: 'widget.erpShortForecastGrid',
   ...
   /* plugins: [Ext.create('Ext.ux.grid.GridHeaderFilters')],*/
    initComponent : function(){
        ...
        this.getGridColumnsAndStore(this, 'scm/sale/getGridConfig.action', gridParam, "");//从后台拿到gridpanel的配置及数据
        	...
        	callback : function(options,success,response){
        		...
        		if(res.columns){
            		...
            		if(!res.data || res.data.length == 2){
            	        ...
            	        var len = data.length;            	           	      
            	        for(var i=0;i<len;i++){
            	            if(Map[data[i].sd_prodcode] == undefined){ 
            	            	var smalldata=data[i];
            	            	...
            	            	Map[data[i].sd_prodcode] =smalldata;
            	            }else{
            	            	var smalldata=Map[data[i].sd_prodcode];
