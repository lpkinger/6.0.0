Ext.define('erp.view.core.window.ReLogin', {
	...
	closeAction: 'destroy',
	isSessionOut: false,
	bodyStyle: 'background: #f2f2f2;padding-top: 15px;padding-left:10px;border:1px solid #bdbdbd !important;',
	layout: 'column',
	initComponent: function() {
		...
		this.items.push({
        	...
        	columnWidth: 1,
        	buttonAlign: 'center',
        	bodyStyle: 'padding-top: 20px;border: none;background: #f2f2f2;',
        	bbar:{style:{background:'#f2f2f2'},items:[{
            	text: '登&nbsp;录&raquo;',
            	name: 'login',
            	height: 25,
            	margin:'0 0 0 70',
	   		...
	   		callback : function(options,success,response){
	   			...
	   			if(localJson.reason){
		    		...
		    		if(refresh){
			    		...
			    		me.close();
			    		parent.document.getElementById('activeUser').innerHTML = username + "(" + em_name + ")";
		    		}
				}
	   		}
		});
