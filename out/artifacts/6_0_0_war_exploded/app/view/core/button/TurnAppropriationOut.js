 ...
 * 转拨出单
 */	
Ext.define('erp.view.core.button.TurnAppropriationOut',{ 
		extend: 'Ext.Button', 
		alias: 'widget.erpTurnAppropriationOutButton',
		iconCls: 'x-button-icon-submit',
    	cls: 'x-btn-gray',
    	id:'turnappropriationout',
    	text: $I18N.common.button.erpTurnAppropriationOutButton,
    	style: {
    		marginLeft: '10px'
        },
        width: 110,
		...
		listeners: {
			...
			click: function(m){
        		Ext.getCmp('turnappropriationout').turn('ProdIN!ToAppropriationOut!Deal', ' pd_piid=' + Ext.getCmp('pi_id').value +' and pd_yqty < pd_inqty + pd_outqty', 'scm/reserve/turnDefectOut.action?type=ProdInOut!AppropriationOut');
        	}
		},
