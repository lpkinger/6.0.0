 ...
 * 转其它采购出库单
 */	
Ext.define('erp.view.core.button.TurnOtherPurcOut',{ 
		extend: 'Ext.Button', 
		alias: 'widget.erpTurnOtherPurcOutButton',
		iconCls: 'x-button-icon-submit',
    	cls: 'x-btn-gray',
    	id:'turnotherpurcout',
    	text: $I18N.common.button.erpTurnOtherPurcOutButton,
    	style: {
    		marginLeft: '10px'
        },
        width: 130,
		...
		listeners: {
			...
			click: function(m){
        		Ext.getCmp('turnotherpurcout').turn('ProdIN!ToProdOtherPurcOut!Deal', ' pd_piid=' + Ext.getCmp('pi_id').value +' and nvl(pd_yqty,0) < nvl(pd_inqty,0) + nvl(pd_outqty,0)', 'scm/reserve/turnDefectOut.action?type=ProdInOut!OtherPurcOut');
        	}
		},
