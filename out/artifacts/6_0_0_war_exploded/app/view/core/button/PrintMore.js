 ...
 * 多种打印格式，打印条码
 */	
Ext.define('erp.view.core.button.PrintMore',{ 
		id:'printmore',
		extend: 'Ext.Button', 
		alias: 'widget.erpPrintMoreButton',
    	...
    	jasperReportPrint:function(caller,reportname,type){    	
	    	...
	    	if(type =='ALL'){//全部打印
		    	...
		    	var data = new Array();
	 	        ...
	 	        condition='( bi_piid='+ key +' and bi_id in ('+data+'))';
	    	}	    
						...
						buttons: [{
							...
							handler: function(b) {
								...
								if(printers && printers.value!= null){
									me.zebraPrint("BarcodeInPrint",printers.value,dpi.value,type);
									b.ownerCt.ownerCt.close();
								}else{
									alert("请选择打印机 ");
								}   
