Ext.define('erp.view.core.button.CommonTransfer',{
	extend : 'Ext.Button',
	alias : 'widget.erpCommonTransfer',
	requires: ['erp.util.FormUtil'],
	iconCls : 'x-button-icon-check',
	text : '通用转单',
	cls: 'x-btn-gray',
	width: 110,
	id: 'erpCommonTransfer',
    ...
    listeners: {
        ...
        click: function(m){
        	...
        	Ext.getCmp('erpCommonTransfer').turn(caller, fo_detailMainKeyField + '=' + Ext.getCmp(fo_keyField).value, 'common/turnCommon.action');
        }
    },
