 ...
 * 转销售退货单
 */	
Ext.define('erp.view.core.button.TurnSaleReturn',{ 
		extend: 'Ext.Button', 
		alias: 'widget.erpTurnSaleReturnButton',
		iconCls: 'x-button-icon-submit',
    	cls: 'x-btn-gray',
    	id:'turnsalereturn',
    	text: $I18N.common.button.erpTurnSaleReturnButton,
    	style: {
    		marginLeft: '10px'
        },
        width: 110,
		...
		listeners: {
			...
			click: function(m){
        		Ext.getCmp('turnsalereturn').turn('ProdInOut!Sale!ToSaleReturn', 
        				' pd_piid=' + Ext.getCmp('pi_id').value +' and nvl(pd_yqty,0)<nvl(pd_outqty,0) order by pd_pdno',
        				'scm/reserve/turnDefectIn.action?type=ProdInOut!SaleReturn');
        	}
		},
