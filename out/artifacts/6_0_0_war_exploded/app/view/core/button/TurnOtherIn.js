 ...
 * 转其它入库单
 */	
Ext.define('erp.view.core.button.TurnOtherIn',{ 
		extend: 'Ext.Button', 
		alias: 'widget.erpTurnOtherInButton',
		iconCls: 'x-button-icon-submit',
    	cls: 'x-btn-gray',
    	id:'turnotherin',
    	text: $I18N.common.button.erpTurnOtherInButton,
    	style: {
    		marginLeft: '10px'
        },
        width: 110,
		...
		listeners: {
			...
			click: function(m){
        		Ext.getCmp('turnotherin').turn('ProdIN!ToProdOtherIn!Deal', ' pd_piid=' + Ext.getCmp('pi_id').value +' and nvl(pd_yqty,0) < nvl(pd_inqty,0) + nvl(pd_outqty,0)', 'scm/reserve/turnDefectIn.action?type=ProdInOut!OtherIn');
        	}
		},
