Ext.define('erp.view.fa.ars.cmCopQuery.QueryWin',{
	id:'erpcopquerywin_'+caller,
	extend: 'Ext.window.Window',
	alias: 'widget.erpCmCopQueryWindow',
    ...
    items:[{
		autoScroll : true,
		anchor: '100% 100%',
		id:'cmcopqueryform_'+caller,
		xtype:'erpCmCopQueryFormPanel',
	...
	buttons:[{
	    ...
	    handler:function(){
	    	var form = Ext.getCmp('cmcopqueryform_'+caller);
	    	form.onQuery();
