Ext.define('erp.view.fa.ars.cmQuery.QueryWin',{
	id:'erpquerywin_'+caller,
	extend: 'Ext.window.Window',
	alias: 'widget.erpCmQueryWindow',
    ...
    items:[{
		autoScroll : true,
		anchor: '100% 100%',
		id:'cmqueryform_'+caller,
		xtype:'erpCmQueryFormPanel',
	...
	buttons:[{
	    ...
	    handler:function(){
	    	var form = Ext.getCmp('cmqueryform_'+caller);
	    	form.onQuery();
