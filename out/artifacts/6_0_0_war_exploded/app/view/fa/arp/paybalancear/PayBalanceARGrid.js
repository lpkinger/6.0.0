Ext.define('erp.view.fa.arp.paybalancear.PayBalanceARGrid',{
	extend:'Ext.grid.Panel',
	alias:'widget.paybalancear',
	requires: ['erp.view.core.toolbar.Toolbar'],
	layout:'fit',
	id:'paybalancearDetailGrid',
	...
	initComponent:function(){
		...
		var condition='';
		if(urlCondition){
			condition = urlCondition.replace('pbd_pbid','pbar_pbid');
	...
	getMyData:function(condition){
		var me = this;
		var caller = (me.caller&&me.caller!='')?me.caller:'PBARGird';
		var params = {
				caller:caller,
				condition:condition
		};
