Ext.define('erp.view.as.port.PreProductList', {
	extend : 'Ext.Viewport',
	layout : 'anchor',
	hideBorders : true,
	initComponent : function() {
		...
		var store = new Ext.data.Store({
			fields : [ 'APPLY_NO', 'STORE_ID', 'STORE_NAME', 'SHENQING_OP', 'OBJECTIVE_STORE',
						'APPLY_DAY', 'APPLY_DATETIME', 'APPLY_OP', 'INOUTNO', 'CLASS',
						'UPDATEMAN', 'UPDATEDATE' ],
				proxy : {
					type : 'ajax',
					url : basePath + 'as/port/getApplyList.action',
					reader : {
						type : 'json',
						root : 'target',
