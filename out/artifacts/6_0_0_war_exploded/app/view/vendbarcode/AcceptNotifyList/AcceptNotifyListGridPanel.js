Ext.define('erp.view.vendbarcode.AcceptNotifyList.AcceptNotifyListGridPanel',{ 
	extend: 'Ext.grid.Panel', 
	layout: 'fit', //fit
	id:'acceptNotifyList',
	requires: ['erp.view.core.plugin.CopyPasteMenu'],
	alias: 'widget.acceptNotifyListGrid',
	...
	dockedItems: [{
        ...
        items:[{
			...
			handler:function(){
				window.location=basePath +'jsps/vendbarcode/acceptNotifylistDetail.jsp?whoami=VendAcceptNotify!Detail';
			}
			}],
        displayInfo: true
	}],
		...
		Ext.apply(me, { 
				...
				store : Ext.create('Ext.data.Store', {
					...
					fields : ['AN_ID', 'AN_CODE', 'AN_DATE', 'AN_STATUS', 'AN_SENDCODE', 'AN_VENDCODE',
						'AN_VENDNAME','AN_RECORDER','AN_INDATE'],
					autoLoad : {
							params: {
								caller: caller,
								condition:condition
					...
					proxy : {
						type : 'ajax',
						url : basePath + 'vendbarcode/datalist/getAcceptNotifyList.action',
						reader : {
							type : 'json',
							root : 'datas',
							totalProperty : 'total'
