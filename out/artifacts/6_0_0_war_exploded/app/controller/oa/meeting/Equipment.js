Ext.QuickTips.init();
Ext.define('erp.controller.oa.meeting.Equipment', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
    		'oa.meeting.Equipment','core.form.Panel','core.trigger.MultiDbfindTrigger','common.datalist.GridPanel','common.datalist.Toolbar',
    ...
    init:function(){
    	...
    	this.control({ 
    		...
    		'erpAddButton': {
    			click: function(btn){
    				me.FormUtil.onAdd('addMeetingRoom', '新增设备', 'jsps/oa/meeting/addEquipment.jsp');
    			}
    		},
    		'erpUpdateButton': {
    			click: function(btn){
    		...
    		'button[name=query]': {
    			click: function(){
    				...
    				grid.getCount('Equipment', condition);//queryform grid caller不同，所以datalist：MeetingRoom
    			}
    		}
    	});
    },
	...
	newMeetingRoom: function(){
    	var win = new Ext.window.Window({
			...
			items: [{
				...
				anchor : '100% 100%',
				layout : 'fit',
				html : '<iframe id="iframe_' + new Date() + '" src="' + basePath + 'jsps/oa/meeting/addEquipment.jsp" height="100%" width="100%" frameborder="0" scrolling="yes"></iframe>'
			}]
		});
    	win.show();	
    },
