Ext.QuickTips.init();
Ext.define('erp.controller.oa.fee.FeeLimitApply', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    GridUtil: Ext.create('erp.util.GridUtil'),
    views:[
    		'oa.fee.FeeLimitApply','core.form.Panel','core.form.FileField','core.form.MultiField','core.form.CheckBoxGroup','core.trigger.MultiDbfindTrigger',
	...
	init:function(){
		...
		this.control({
			...
			'erpAddButton': {
				click: function(){
					me.FormUtil.onAdd('addFeeLimitApply', '新增额度申请', 'jsps/oa/fee/feeLimitApply.jsp');
				}
			},'erpSubmitButton': {
