Ext.QuickTips.init();
Ext.define('erp.controller.oa.myProcess.JProcessMonitoring', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    GridUtil: Ext.create('erp.util.GridUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
     		'oa.myProcess.jprocessMonitoring.Viewport','oa.myProcess.jprocessMonitoring.GridPanel','oa.myProcess.jprocessMonitoring.Form',
