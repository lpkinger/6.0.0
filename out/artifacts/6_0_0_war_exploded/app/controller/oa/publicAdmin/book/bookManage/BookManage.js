Ext.QuickTips.init();
Ext.define('erp.controller.oa.publicAdmin.book.bookManage.BookManage', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
    		'oa.publicAdmin.book.bookManage.BookManage','common.datalist.GridPanel','common.datalist.Toolbar','common.query.Form',
    		'core.trigger.DbfindTrigger','core.form.ConDateField','core.toolbar.Toolbar','oa.publicAdmin.book.bookManage.Form'
    	],
    init:function(){
    	var me = this;
    	this.control({
