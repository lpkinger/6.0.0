Ext.QuickTips.init();
Ext.define('erp.controller.oa.publicAdmin.book.bookManage.BookInquiry', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
    		'oa.publicAdmin.book.bookManage.BookInquiry','common.datalist.GridPanel','common.datalist.Toolbar','common.query.Form',
