Ext.QuickTips.init();
Ext.define('erp.controller.oa.publicAdmin.book.returnManage.ReturnApp', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
    		'oa.publicAdmin.book.returnManage.ReturnApp','common.datalist.GridPanel','common.datalist.Toolbar',
...
/*	'field[name=bo_isloan]': {
    ...
    vastReturn: function(){
		...
		if(records.length > 0){
			...
			Ext.Ajax.request({
		   		url : basePath + 'oa/publicAdmin/book/returnManage/vastReturn.action',
		   		params: {
		   			id: id
		   		},
		   		method : 'post',
		   		callback : function(options,success,response){
	    			...
	    			if(localJson.success){
		   				Ext.Msg.alert("提示", "提交归还申请成功!", function(){
