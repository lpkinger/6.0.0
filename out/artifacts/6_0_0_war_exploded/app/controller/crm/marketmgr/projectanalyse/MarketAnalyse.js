Ext.QuickTips.init();
Ext.define('erp.controller.crm.marketmgr.projectanalyse.MarketAnalyse', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
    		'crm.marketmgr.projectanalyse.MarketAnalyse','core.form.Panel','core.form.FileField','core.form.MultiField',
	...
	init:function(){
		...
		this.control({
			...
			'erpAddButton': {
				click: function(){
					me.FormUtil.onAdd('addMarketAnalyse', '新增市场分析报告', 'jsps/crm/marketmgr/projectanalyse/marketAnalyse.jsp');
				}
			},'erpSubmitButton': {
