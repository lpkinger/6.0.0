Ext.QuickTips.init();
Ext.define('erp.controller.crm.marketmgr.marketchange.ChangeProject', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
    		'crm.marketmgr.marketchange.ChangeProject','core.form.Panel','core.form.FileField','core.form.MultiField','core.form.CheckBoxGroup',
	...
	init:function(){
		...
		this.control({
			...
			'erpcheckboxgroup[name=cp_servicetype]':{
			...
			'erpAddButton': {
				click: function(){
					me.FormUtil.onAdd('addChangeProject', '新增项目变更单', 'jsps/crm/marketmgr/marketchange/changeProject.jsp');
				}
			},'erpSubmitButton': {
...
/*			'textfield[id=cp_prjname]':{
				change:function(btn){
					var form=Ext.getCmp('form');
					setTimeout.('alert(11)',10);
				}
			},*/
			'dbfindtrigger[name=cp_prjcode]':{
