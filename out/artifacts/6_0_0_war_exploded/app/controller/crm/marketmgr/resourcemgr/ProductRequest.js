Ext.QuickTips.init();
Ext.define('erp.controller.crm.marketmgr.resourcemgr.ProductRequest', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
    		'crm.marketmgr.resourcemgr.ProductRequest','core.form.Panel','core.form.FileField','core.form.MultiField','core.form.CheckBoxGroup',
	...
	init:function(){
		...
		this.control({
			...
			'erpAddButton': {
				click: function(){
					me.FormUtil.onAdd('addProductRequest', '新增产品培训需求表', 'jsps/crm/marketmgr/resourcemgr/productRequest.jsp?whoami='+caller);
				}
			},'erpSubmitButton': {
