Ext.QuickTips.init();
Ext.define('erp.controller.crm.marketmgr.resourcemgr.PreResource', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
    		'crm.marketmgr.resourcemgr.PreResource','core.form.Panel','core.form.FileField','core.form.MultiField','core.form.CheckBoxGroup',
	...
	init:function(){
		...
		this.control({
			...
			'erpAddButton': {
				click: function(){
					me.FormUtil.onAdd('addPreResource', '新增资源预录入', 'jsps/crm/marketmgr/resourcemgr/preResource.jsp');
				}
			},'erpSubmitButton': {
