Ext.QuickTips.init();
Ext.define('erp.controller.crm.marketmgr.marketresearch.Research', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
    		'crm.marketmgr.marketresearch.Research','core.form.Panel','core.form.FileField','core.form.MultiField',
	...
	init:function(){
		...
		this.control({
			...
			'erpAddButton': {
				click: function(){
					me.FormUtil.onAdd('addResearch', '新增调研计划', 'jsps/crm/marketmgr/marketresearch/Research.jsp');
				}
			},
			'erpCloseButton': {
				click: function(btn){
