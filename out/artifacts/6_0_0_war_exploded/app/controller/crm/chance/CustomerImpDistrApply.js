Ext.QuickTips.init();
Ext.define('erp.controller.crm.chance.CustomerImpDistrApply', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    GridUtil : Ext.create('erp.util.GridUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
    		'crm.chance.CustomerImpDistrApply','core.form.Panel','core.form.FileField','core.form.MultiField','core.grid.Panel2', 'core.toolbar.Toolbar', 'core.grid.YnColumn',
	...
	init:function(){
		...
		this.control({
			...
			'erpAddButton': {
				click: function(){
					me.FormUtil.onAdd('addCustomerImpDistrApply', '新增客户分配申请单', 'jsps/crm/chance/customerDistrApply.jsp');
				}
			},
			'erpCloseButton': {
				click: function(btn){
