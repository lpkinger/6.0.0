Ext.QuickTips.init();
Ext.define('erp.controller.crm.chance.Scheduler', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
    		'crm.chance.Scheduler','core.form.Panel','core.form.FileField','core.form.MultiField',
	...
	init:function(){
		...
		this.control({
			...
			'erpAddButton': {
				click: function(){
					me.FormUtil.onAdd('addScheduler', '新增商机沟通计划', 'jsps/crm/chance/scheduler.jsp');
				}
			},
			'erpCloseButton': {
				click: function(btn){
