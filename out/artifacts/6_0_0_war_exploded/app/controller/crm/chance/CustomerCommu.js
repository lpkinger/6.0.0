Ext.QuickTips.init();
Ext.define('erp.controller.crm.chance.CustomerCommu', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
    		'crm.chance.CustomerCommu','core.form.Panel','core.form.FileField','core.form.MultiField',
	...
	init:function(){
		...
		this.control({
			...
			'erpAddButton': {
				click: function(){
					me.FormUtil.onAdd('addScheduler', '新增客户沟通记录', 'jsps/crm/chance/customerCommu.jsp');
				}
			},
			'erpCloseButton': {
				click: function(btn){
