Ext.QuickTips.init();
Ext.define('erp.controller.crm.chance.ChanceManage', {
    extend: 'Ext.app.Controller',
    requires: ['erp.util.FormUtil', 'erp.util.GridUtil', 'erp.util.BaseUtil', 'erp.util.RenderUtil'],
    views:[
     		'common.batchDeal.Viewport','common.batchDeal.Form','crm.chance.ChanceManage',
    			...
    			beforerender:function(btn){
    				btn.handler=function(select){
    					...
    					if(grid.getGridColumnsAndStore){
    						grid.loadNewStore(grid, 'crm/Chance/singleGridPanel.action', gridParam, "");
    					}
    					if(select == true) {
