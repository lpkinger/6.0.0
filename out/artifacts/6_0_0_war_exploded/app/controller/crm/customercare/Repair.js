Ext.QuickTips.init();
Ext.define('erp.controller.crm.customercare.Repair', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
    		'crm.customercare.Repair','core.form.Panel','core.form.FileField','core.form.MultiField',
	...
	init:function(){
		...
		this.control({
			...
			'erpAddButton': {
				click: function(){
					me.FormUtil.onAdd('addRepair', '新增维修单', 'jsps/crm/customercare/repair.jsp');
				}
			},
			'erpCloseButton': {
				click: function(btn){
