Ext.QuickTips.init();
Ext.define('erp.controller.crm.customercare.CallPlan', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
    		'crm.customercare.CallPlan','core.form.Panel','core.form.FileField','core.form.MultiField',
	...
	init:function(){
		...
		this.control({
			...
			'erpAddButton': {
				click: function(){
					me.FormUtil.onAdd('addChance', '新增商机', 'jsps/crm/customercare/callPlan.jsp');
				}
			},
			'erpCloseButton': {
				click: function(btn){
