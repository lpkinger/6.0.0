Ext.QuickTips.init();
Ext.define('erp.controller.hr.emplmana.Turnfullmemb', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    GridUtil: Ext.create('erp.util.GridUtil'),
    views:[
   		'hr.emplmana.Turnfullmemb','core.form.Panel','core.grid.Panel2','core.toolbar.Toolbar',
    ...
    init:function(){
    	...
    	this.control({ 
    		...
    		'erpAddButton': {
    			click: function(){
    				me.FormUtil.onAdd('addTurnfullmemb', '新增用人申请', 'jsps/hr/emplmana/employee/turnfullmemb.jsp');
    			}
    		},'erpSubmitButton': {
