Ext.QuickTips.init();
Ext.define('erp.controller.hr.attendance.holiday', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    GridUtil: Ext.create('erp.util.GridUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
      		'core.form.Panel','hr.attendance.holiday','core.grid.Panel2','core.toolbar.Toolbar','core.form.MultiField',
      		...
      		'core.trigger.DbfindTrigger','core.trigger.TextAreaTrigger','core.trigger.MultiDbfindTrigger','core.form.DateHourMinuteComboField'
      	],
    init:function(){
    	var me = this;
    	me.allowinsert = true;
    	this.control({
    		...
    		'erpDeleteButton' : {
    			click: function(btn){
    				me.FormUtil.onDelete(Ext.getCmp('ho_id').value);
    			}
    		},
    		'erpUpdateButton': {
    			afterrender: function(btn){
    				var status = Ext.getCmp('ho_statuscode');
    		...
    		'erpAddButton': {
    			click: function(){
    				me.FormUtil.onAdd('addHoliday', '新增员工节假日', 'jsps/hr/attendance/holiday.jsp');
    			}
    		},
    		'erpCloseButton': {
    			click: function(btn){
