Ext.QuickTips.init();
Ext.define('erp.controller.hr.kbi.KBIScheme', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    GridUtil: Ext.create('erp.util.GridUtil'),
    views:[
    		'hr.kbi.KBIScheme','core.form.Panel','core.form.FileField','core.form.MultiField','core.form.CheckBoxGroup',
	...
	init:function(){
		...
		this.control({
			...
			'erpAddButton': {
				click: function(){
					me.FormUtil.onAdd('addKBIScheme', '新增KBI方案', 'jsps/hr/kbi/kBIScheme.jsp');
				}
			},'erpSubmitButton': {
