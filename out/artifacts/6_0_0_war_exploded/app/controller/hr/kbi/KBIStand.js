Ext.QuickTips.init();
Ext.define('erp.controller.hr.kbi.KBIStand', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    GridUtil: Ext.create('erp.util.GridUtil'),
    views:[
    		'hr.kbi.KBIStand','core.form.Panel','core.form.FileField','core.form.MultiField','core.form.CheckBoxGroup',
	...
	init:function(){
		...
		this.control({
			...
			'erpAddButton': {
				click: function(){
					me.FormUtil.onAdd('addKBIStand', '新增KBI指标', 'jsps/hr/kbi/kBIStand.jsp');
				}
			},'erpSubmitButton': {
