Ext.QuickTips.init();
Ext.define('erp.controller.hr.kpi.KpiAccount', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views: ['hr.kpi.KpiAccount', 'core.button.Confirm', 'core.button.Close', 'core.form.MonthDateField','core.form.Panel','core.form.FileField',
    ...
    confirm: function() {
        var me = this;
        Ext.MessageBox.confirm('提示', '确定要计算考核数据吗?',
        function(btn) {
            if (btn == 'yes') {
