Ext.QuickTips.init();
Ext.define('erp.controller.hr.kpi.KpiPosition', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    GridUtil: Ext.create('erp.util.GridUtil'),
    views:[
    		'hr.kpi.KpiPosition','core.form.Panel','core.form.FileField','core.form.MultiField','core.form.CheckBoxGroup','core.trigger.MultiDbfindTrigger',
      		'core.button.Save','core.button.Add','core.button.Submit','core.button.Print','core.button.Upload','core.button.ResAudit','hr.kpi.PositionGrid',
	...
	init:function(){
		var me = this;
		this.control({
			'hidden[name=kp_positionid]':{
				change:function(field){
					var grid = Ext.getCmp('positionGrid');
					var gridParam = {caller: caller, condition: "kp_positionid="+field.value};
					grid.loadNewStore(grid,'hr/kpi/singleGridPanel.action',gridParam,"");
				}
			},
			'erpSaveButton': {
				click: function(btn){
	   		...
	   		callback : function(options,success,response){
	   				...
	   				if(localJson.exceptionInfo){
	    				...
	    				saveSuccess(function(){
	    					var gridParam = {caller: caller, condition: "kp_positionid="+Ext.getCmp('kp_positionid').value};
	    					grid.loadNewStore(grid,'hr/kpi/singleGridPanel.action',gridParam,"");
	    				});
		   			} 
	   			}
