Ext.QuickTips.init();
Ext.define('erp.controller.hr.wage.base.WageBase',{
	extend:'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    GridUtil: Ext.create('erp.util.GridUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
	views:[
		'hr.wage.base.WageBase',
		'core.form.Panel',
		'core.grid.Panel2',
		...
		this.control({
            'erpGridPanel2': {
                afterrender: function(grid) {
                    var status = Ext.getCmp('wb_statuscode');
    		...
    		'erpDeleteButton': {
    			...
    			click: function(btn){
    				me.FormUtil.onDelete(Ext.getCmp('wb_id').value);
    			}
    		},
            'erpSubmitButton': {
                afterrender: function(btn) {
                ...
                click: {	
                    lock: 2000,
	                fn:function(btn) {
                        me.FormUtil.onSubmit(Ext.getCmp('wb_id').value);
	                }
                }
            },
            'erpResSubmitButton': {
                ...
                click: {
                    lock: 2000,
	                fn:function(btn) {
                        me.FormUtil.onResSubmit(Ext.getCmp('wb_id').value);
	                }
                }
            },
            'erpAuditButton': {
                ...
                click:{ 
    				lock: 2000,
	                fn: function(btn) {
                    	me.FormUtil.onAudit(Ext.getCmp('wb_id').value);
	                }
                }
            },
            'erpResAuditButton': {
                ...
                click:{ 
    				lock: 2000,
	                fn: function(btn) {
                  	  	me.FormUtil.onResAudit(Ext.getCmp('wb_id').value);
	                }
                }
            },
    		'erpAddButton': {
    			click: function(){
    				me.FormUtil.onAdd('addWageBase', '新增基础项', 'jsps/hr/wage/base/wagebase.jsp');
    			}
    		}            
		});
	},
