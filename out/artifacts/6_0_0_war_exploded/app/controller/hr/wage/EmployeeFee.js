Ext.QuickTips.init();
Ext.define('erp.controller.hr.wage.EmployeeFee', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    GridUtil: Ext.create('erp.util.GridUtil'),
    views:[
    		'hr.wage.EmployeeFee','core.form.Panel','core.form.FileField','core.form.MultiField','core.form.CheckBoxGroup','core.trigger.MultiDbfindTrigger',
	...
	init:function(){
		...
		this.control({
			...
			'erpAddButton': {
				click: function(){
					me.FormUtil.onAdd('addEmployeeFee', '新增人员薪资维护', 'jsps/hr/wage/employeeFee.jsp');
				}
			},'erpSubmitButton': {
