Ext.QuickTips.init();
Ext.define('erp.controller.plm.cost.MonthAccountOver', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
    		'plm.cost.MonthAccountOver',
    	...
    	startAccount: function(){
    		Ext.Ajax.request({
    			url : basePath + "plm/cost/startAccount.action",
    			params:{
    	...
    	overAccount: function(){
    		Ext.Ajax.request({
    			url : basePath + "plm/cost/overAccount.action",
    			params:{
    				param:{date:Ext.getCmp('date').value},
    			},
    			method:'post',
