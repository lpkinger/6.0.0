Ext.QuickTips.init();
Ext.define('erp.controller.plm.project.Productline', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
    		'plm.project.Productline','core.form.Panel','core.form.FileField','core.form.MultiField',
	...
	init:function(){
		...
		this.control({
			...
			'erpAddButton': {
				click: function(){
					me.FormUtil.onAdd('addProductline', '新增新产品线引进审批表', 'jsps/plm/project/productline.jsp');
				}
			},'erpSubmitButton': {
