Ext.QuickTips.init();
Ext.define('erp.controller.fa.fix.AssetsIO', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    GridUtil: Ext.create('erp.util.GridUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
      		'core.form.Panel','fa.fix.AssetsIO','core.grid.Panel2','core.toolbar.Toolbar',
    ...
    init:function(){
    	...
    	this.control({ 
    		...
    		'erpDeleteButton' : {
    			click: function(btn){
    				me.FormUtil.onDelete({ai_id: Number(Ext.getCmp('ai_id').value)});
    			}
    		},
    		'erpUpdateButton': {
    			click: function(btn){
    		...
    		'erpAddButton': {
    			click: function(){
    				me.FormUtil.onAdd('add' + caller, '新增', "jsps/fa/fix/assetsIO.jsp?whoami=" + caller);
    			}
    		},
    		'erpCloseButton': {
    			click: function(btn){
    		...
    		'erpSubmitButton': {
    			...
    			click: function(btn){
    				me.FormUtil.onSubmit(Ext.getCmp('ai_id').value);
    			}
    		},
    		'erpResSubmitButton': {
    			afterrender: function(btn){
    		...
    		'erpBannedButton': {
    			...
    			click: function(btn){
    				me.FormUtil.onBanned(Ext.getCmp('ai_id').value);
    			}
    		},
    		'erpResBannedButton': {
    			afterrender: function(btn){
    			...
    			click: function(btn){
    				me.FormUtil.onResBanned(Ext.getCmp('ai_id').value);
    			}
    		},
    		'erpPrintButton': {
    			click: function(btn){
    				me.FormUtil.onPrint(Ext.getCmp('ai_id').value);
    			}
    		},
    		'erpPostButton': {
    			afterrender: function(btn){
    		...
    		'erpScanButton': {
    			afterrender: function(btn){
    				btn.urlcondition =  "ai_statuscode<>'DELETED' and ai_class = '"+Ext.getCmp("ai_class").getValue()+"'";
    			}
    		}
    	});
    },
