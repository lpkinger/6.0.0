Ext.QuickTips.init();
Ext.define('erp.controller.fa.ars.VoucherDescription', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    GridUtil: Ext.create('erp.util.GridUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
      		'core.form.Panel','fa.ars.VoucherDescription','core.grid.Panel2','core.toolbar.Toolbar',
...
*/    				this.FormUtil.beforeSave(this);
    		...
    		'erpAddButton': {
    			click: function(){
    				me.FormUtil.onAdd('addVoucherDescription', '新增常用摘要', 'jsps/fa/ars/voucherDescription.jsp');
    			}
    		},
    		'erpCloseButton': {
    			click: function(btn){
