Ext.QuickTips.init();
Ext.define('erp.controller.fa.ars.CmCopQuery', {
    extend: 'Ext.app.Controller',
    GridUtil: Ext.create('erp.util.GridUtil'),
    condition:'',
    views:[
     		'fa.ars.cmCopQuery.Viewport','fa.ars.cmCopQuery.GridPanel','fa.ars.cmCopQuery.QueryForm','fa.ars.cmCopQuery.QueryWin',
    ...
    init:function(){
    	var me = this;
    	this.control({
    		'erpCmCopQueryFormPanel button[name=confirm]': {
    			
    		},
    		'button[name=refresh]':{
    			click: function(btn){
    				Ext.getCmp('cmcopquerygrid').setLoading(true);
    				Ext.Ajax.request({
    					url: basePath + 'fa/ars/CmQueryController/refreshCmCopQuery.action',
    					method: 'GET',
    					timeout: 120000,
    					callback: function(opt, s, r) {
    						Ext.getCmp('cmcopquerygrid').setLoading(false);
    	...
    	var filter = Ext.create('Ext.Window', {
    	    ...
    	    buttons: [{
	    		...
	    		handler: function(btn) {
					...
					var grid = Ext.getCmp('cmcopquerygrid');
    ...
    query: function(cond) {
    	...
    	Ext.Ajax.request({
    		url: basePath + 'fa/ars/CmQueryController/getCmCopQuery.action',
    		params: {
