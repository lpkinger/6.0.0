Ext.QuickTips.init();
Ext.define('erp.controller.fa.ars.VoucherKind', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    GridUtil: Ext.create('erp.util.GridUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
      		'core.form.Panel','fa.ars.VoucherKind','core.grid.Panel2','core.toolbar.Toolbar',
...
*/    				this.FormUtil.beforeSave(this);
    		...
    		'erpDeleteButton' : {
    			click: function(btn){
    				me.FormUtil.onDelete(Ext.getCmp('vk_id').value);
    			}
    		},
    		'erpUpdateButton': {
    			click: function(btn){
    		...
    		'erpAddButton': {
    			click: function(){
    				me.FormUtil.onAdd('addVoucherKind', '新增凭证类型维护', 'jsps/fa/ars/voucherKind.jsp');
    			}
    		},
    		'erpCloseButton': {
    			click: function(btn){
