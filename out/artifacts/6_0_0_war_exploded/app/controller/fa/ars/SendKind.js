Ext.QuickTips.init();
Ext.define('erp.controller.fa.ars.SendKind', {
    ...
    init:function(){
    	...
    	this.control({
    		...
    		'dbfindtrigger[name=sk_salecatecode]': {
    			focus: function(t){
    		...
    		'dbfindtrigger[name=sk_costcatecode]': {
    			focus: function(t){
    				Ext.getCmp('grid').dbfinds = [{
    					dbGridField: 'ca_code', 
    ...
    */this.GridUtil.onGridItemClick(selModel, record);
	...
	update:function(param){
		console.log(param);
		Ext.Ajax.request({
		    url: basePath+'fa/ars/updateSendKind.action',
		    params:{
		    	param:param
		    },
