Ext.QuickTips.init();
Ext.define('erp.controller.fa.gs.BillARCheque', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    GridUtil: Ext.create('erp.util.GridUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
    		'fa.gs.BillARCheque','core.form.Panel','core.form.MultiField','core.form.FileField','core.form.MultiField',
    ...
    init:function(){
    	...
    	this.control({ 
    		...
    		'erpAddButton': {
    			click: function(){
    				me.FormUtil.onAdd('addBillARCheque', '新增支票', 'jsps/fa/gs/billARCheque.jsp');
    			}
    		},
    		'erpUpdateButton': {
    			click: function(btn){
    							   ...
    							   buttons: [{
    								   ...
    								   handler: function(btn) {
    									   ...
    									   if(form.getForm().isDirty()) {
    										   me.endBillARCheque(Ext.getCmp('bar_id').value, a.value);
    									   }
    								   }
    							   }, {
                ...
                click: function(btn) {
                	warnMsg("确定反结案?", function(btn){
    					if(btn == 'yes'){
    	    				...
    	    				Ext.Ajax.request({
    	    			   		url : basePath + 'fa/gs/resEndBillARCheque.action',
    	    			   		params: {
    	    			   			caller: caller,
    ...
    updateInfo:function(text,id){
		Ext.Ajax.request({
        	url : basePath + 'fa/gs/billARCheque/updateInfo.action',
    ...
    copy: function(){
		...
		if(v > 0) {
			...
			Ext.Ajax.request({
				url: basePath + 'fa/gs/copyBillARCheque.action',
				params: {
					id: v
				},
				callback: function(opt, s, r){
					...
					if(res.ar) {
						turnSuccess(function(){
	    					...
	    					var url = "jsps/fa/gs/billARCheque.jsp?formCondition=bar_idIS"+ id ;
	    					me.FormUtil.onAdd('BillARCheque' + id, '支票' + id, url);
	    				});
					} else {
	...
	endBillARCheque: function(barid, val) {
		var me = this;
 	   	Ext.Ajax.request({
 		   url: basePath + 'fa/gs/endBillARCheque.action',
 		   params: {
 			   caller: caller,
 			   id: barid,
 			   reason: val
    ...
    turnBankRegister: function(){
        ...
        Ext.Ajax.request({
  		   url: basePath + 'fa/gs/chequeToAccountRegister.action',
  		   params: {
  			   caller: caller,
  			   id: bar_id,
