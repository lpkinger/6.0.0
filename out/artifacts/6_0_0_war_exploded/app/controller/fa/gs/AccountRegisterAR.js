Ext.QuickTips.init();
Ext.define('erp.controller.fa.gs.AccountRegisterAR', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
    		'fa.gs.AccountRegisterAR','core.form.Panel','fa.gs.AccountRegisterTree','common.datalist.GridPanel',
    		...
    		'erpAddButton':{
    			click: function(btn){
    				var record = me.lastSelected,
    					url = 'jsps/fa/gs/accountRegister.jsp?whoami=AccountRegister!AR';
    				if(record) {
