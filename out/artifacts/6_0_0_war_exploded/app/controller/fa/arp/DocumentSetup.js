Ext.QuickTips.init();
Ext.define('erp.controller.fa.arp.DocumentSetup', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    GridUtil: Ext.create('erp.util.GridUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
     		'core.grid.Panel4','core.toolbar.Toolbar3','core.button.Save','core.grid.YnColumn','core.trigger.DbfindTrigger'
	...
	update:function(param){
		Ext.Ajax.request({
		    url: basePath+'fa/updateDocumentSetup.action',
		    params:{
		    	param:param
		    },
