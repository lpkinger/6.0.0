Ext.QuickTips.init();
Ext.define('erp.controller.fa.gla.GLDetail2', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views: ['core.trigger.DbfindTrigger', 'fa.gla.GLDetail2', 'fa.gla.LedgerDetail', 'core.form.MonthDateField', 'core.trigger.CateTreeDbfindTrigger',
    ...
    query: function(cond) {
    	...
    	Ext.Ajax.request({
    		url: basePath + 'fa/ars/getGLDetail2.action',
    		params: {
    			...
    			if(res.filter) {
    				...
    				if(ass){
    					if(ass.lastName) {
    						...
    						Ext.getCmp('gl_info_ass').setText(ass.lastName);
    					} 
    				}
    			}
    		}
