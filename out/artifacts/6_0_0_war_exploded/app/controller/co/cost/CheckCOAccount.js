Ext.QuickTips.init();
Ext.define('erp.controller.co.cost.CheckCOAccount', {
    extend: 'Ext.app.Controller',
    requires: ['erp.util.BaseUtil'],
    views: ['co.cost.CheckCOAccount'],
    ...
    startAccount: function(){
    	...
    	overAccount: function(){
    		var me = this;
    		Ext.Msg.confirm('提示','反结账后当前账期'+me.currentMonth+'的成本表数据将被清空，确定要继续吗？',function(option){
				if(option=='yes'){
					me.FormUtil.setLoading(true);
		    		Ext.Ajax.request({
