Ext.QuickTips.init();
Ext.define('erp.controller.co.cost.AccountParaSetup', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    GridUtil: Ext.create('erp.util.GridUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
            'co.cost.AccountParaSetup','core.grid.Panel4',
      		'core.button.Save','core.button.ResPost',
      		'core.trigger.DbfindTrigger','core.toolbar.Toolbar3'
      	],
    init:function(){
    	var me = this;
...
//    					   				break;
//    					   			}
    					   			column.setEditor(new erp.view.core.trigger.DbfindTrigger({value: e.value}));
    					   			column.xtype = 'dbfindcolumn';
    					   			break;
    					   		case "C"://下拉框
...
//		console.log(items);
	...
	update:function(param){
		Ext.Ajax.request({
		    url: basePath+'fa/ars/updateAccountParaSetup.action',
		    params:{
		    	param:param
		    },
		    success: function(response){
		        ...
		        if(result.success){
		        	Ext.Msg.alert("提示","操作成功！"); // 尚未国际化，以后订正。
		        }
		    }
		});
	}
