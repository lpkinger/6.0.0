Ext.QuickTips.init();
Ext.define('erp.controller.pm.make.MakePlant', {
    extend: 'Ext.app.Controller',
    requires: ['erp.util.FormUtil', 'erp.util.GridUtil', 'erp.util.BaseUtil'],
    views:[
            'core.button.PrintByCondition','core.form.Panel','pm.make.MakePlant','core.grid.Panel2','core.toolbar.Toolbar','core.form.MultiField','core.form.YnField',
