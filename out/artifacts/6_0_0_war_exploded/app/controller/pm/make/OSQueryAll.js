Ext.QuickTips.init();
Ext.define('erp.controller.pm.make.OSQueryAll', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
    		'pm.make.OSQueryAll','common.datalist.GridPanel','common.datalist.Toolbar','common.batchDeal.Form',
    ...
    init:function(){
    	...
    	this.control({
    		...
    		'monthdatefield[name=mmm_yearmonth]':{
    		...
    		'erpVastDealButton':{
    			click:function(btn){
    				...
    				if(!currentMonth) {
	    				...
	    				Ext.Ajax.request({
	    					url:basePath+'pm/make/MakeMonth.action',
	    					method:'post',
	    					params:{	
