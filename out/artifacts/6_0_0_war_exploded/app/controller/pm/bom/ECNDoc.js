Ext.QuickTips.init();
Ext.define('erp.controller.pm.bom.ECNDoc', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    GridUtil: Ext.create('erp.util.GridUtil'),
    views:[
    		'pm.bom.ECNDoc','core.form.Panel','core.grid.Panel2','core.toolbar.Toolbar',
    ...
    init:function(){
    	...
    	this.control({ 
    		...
    		'erpAddButton': {
    			click: function(){
    				me.FormUtil.onAdd('addECNDOC', '新增设计变更评审单', 'jsps/pm/bom/ECNDoc.jsp');
    			}
    		},
    		'erpSubmitButton': {
    			afterrender: function(btn){
    				var status = Ext.getCmp('ecn_checkstatuscode2');
