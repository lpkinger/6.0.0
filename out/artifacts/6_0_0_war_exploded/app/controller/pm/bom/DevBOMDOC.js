Ext.QuickTips.init();
Ext.define('erp.controller.pm.bom.DevBOMDOC', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    GridUtil: Ext.create('erp.util.GridUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
      		'core.form.Panel','pm.bom.DevBOMDOC','core.grid.Panel2','core.toolbar.Toolbar',
	...
	init:function(){
		...
		this.control({
			...
			'erpAddButton': {
				click: function(){
					me.FormUtil.onAdd('addDevBOMDOC', '新增BOM说明', 'jsps/pm/bom/devBOMDOC.jsp');
				}
			},
			'erpCloseButton': {
				click: function(btn){
