Ext.QuickTips.init();
Ext.define('erp.controller.drp.distribution.terminalSale', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    GridUtil: Ext.create('erp.util.GridUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
      		'core.form.Panel','drp.distribution.terminalSale','core.grid.Panel2','core.toolbar.Toolbar','core.form.MultiField',
...
//    		},
    		...
    		'erpDeleteButton' : {
    			click: function(btn){
    				me.FormUtil.onDelete(Ext.getCmp('ts_id').value);
    			}
    		},
    		'erpUpdateButton': {
    			afterrender: function(btn){
    				var status = Ext.getCmp('ts_statuscode');
    		...
    		'erpAddButton': {
    			click: function(){
    				me.FormUtil.onAdd('addTerminalSale', '新终端销货单', 'jsps/drp/distribution/terminalSale.jsp');
    			}
    		},
    		'erpCloseButton': {
    			click: function(btn){
            ...
            'erpSubmitButton': {
    			...
    			click: function(btn){
    				me.FormUtil.onSubmit(Ext.getCmp('ts_id').value);
    			}
    		},
    		'erpResSubmitButton': {
    			afterrender: function(btn){
    			...
    			click: function(btn){
    				me.FormUtil.onResSubmit(Ext.getCmp('ts_id').value);
    			}
    		},
    		'erpAuditButton': {
    			afterrender: function(btn){
    			...
    			click: function(btn){
    				me.FormUtil.onAudit(Ext.getCmp('ts_id').value);
    			}
    		},
    		'erpResAuditButton': {
    			afterrender: function(btn){
    			...
    			click: function(btn){
    				me.FormUtil.onResAudit(Ext.getCmp('ts_id').value);
    			}
    		}
    	});
    }, 
