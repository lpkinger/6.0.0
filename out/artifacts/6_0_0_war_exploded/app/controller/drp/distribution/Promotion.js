Ext.QuickTips.init();
Ext.define('erp.controller.drp.distribution.Promotion', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    GridUtil: Ext.create('erp.util.GridUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
      		'core.form.Panel','drp.distribution.Promotion','core.grid.Panel2','core.toolbar.Toolbar','core.form.MultiField',
    ...
    init:function(){
    	...
    	this.control({
    		...
    		'erpDeleteButton' : {
    			click: function(btn){
    				me.FormUtil.onDelete(Ext.getCmp('pt_id').value);
    			}
    		},
    		'erpUpdateButton': {
    		...
    		'erpAddButton': {
    			click: function(){
    				me.FormUtil.onAdd('addPromotion', '新增终端日常促销申请', 'jsps/drp/distribution/promotion.jsp');
    			}
    		},
    		'erpCloseButton': {
    			click: function(btn){
