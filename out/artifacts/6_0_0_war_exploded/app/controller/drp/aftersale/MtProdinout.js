Ext.QuickTips.init();
Ext.define('erp.controller.drp.aftersale.MtProdinout', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    GridUtil: Ext.create('erp.util.GridUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
      		'core.form.Panel','drp.aftersale.MtProdinout','core.grid.Panel2','core.toolbar.Toolbar','core.form.MultiField',
      		'core.button.Save','core.button.Add','core.button.Submit','core.button.Print','core.button.Upload','core.button.ResAudit',
      			'core.button.Audit','core.button.Close','core.button.Delete','core.button.Update','core.button.DeleteDetail',
      			'core.button.ResSubmit','core.button.TurnStorage','core.button.TurnCheck','core.button.Post','core.button.ResPost',
    ...
    init:function(){
    	...
    	this.control({
    		...
    		'erpAddButton': {
    			click: function(){
    				me.FormUtil.onAdd('addProdiout', '新增采购收料单', 'jsps/drp/aftersale/prodioutlin.jsp');
    			}
    		},
    		'erpCloseButton': {
    			click: function(btn){
    		...
    		'erpPrintButton': {
                click: function(btn) {
                    var reportName = '';
                    var condition = '{mtprodinout.mt_id}=' + Ext.getCmp('mt_id').value + '';
