Ext.QuickTips.init();
Ext.define('erp.controller.drp.aftersale.prodioutlin', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    GridUtil: Ext.create('erp.util.GridUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
      		'core.form.Panel','drp.aftersale.prodioutlin','core.grid.Panel2','core.toolbar.Toolbar','core.form.MultiField',
