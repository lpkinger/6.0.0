Ext.define('erp.controller.ma.logic.Config', {
    extend: 'Ext.app.Controller',
    stores: ['TreeStore'],
    views: ['common.main.TreePanel','ma.logic.Config', 'core.form.ColorField',
    	...
    	this.control({ 
    		...
    		'button[id=btn-close]': {
    			click: function(){
    				...
    				//lidy  2017120136   解决 单据维护界面》选项》单据设置》逻辑配置  的关闭按钮不能关闭窗口。
    				var config = parent.Ext.getCmp('iframe_detail_config');
    				if(config!=null){
    					var settingWin = config.ownerCt.ownerCt.ownerCt;
    						...
    						s.push({
								...
								store: Ext.create('Ext.data.Store', {
								   ...
								   data : [{"display": '物料+供应商+币别+类型--最新有效价格', "value": 'A'},
								           ...
								           {"display": '物料+供应商+类型——最新有效价格', "value": 'F'},
								           {"display": '物料+类型+最新失效价格——最近失效价格', "value": 'G'}]
							   }),
