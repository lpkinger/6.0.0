Ext.QuickTips.init();
Ext.define('erp.controller.b2c.component.b2cProdResource', {
    extend: 'Ext.app.Controller',
    requires: ['erp.util.FormUtil', 'erp.util.GridUtil', 'erp.util.BaseUtil', 'erp.util.RenderUtil'],
    views:[
     		'b2c.common.Viewport','b2c.component.b2cPanel','b2c.common.b2cBatchDealForm','b2c.common.b2cBatchDealGrid','core.form.MultiField',
    	...
    	this.control({ 
    		'erpBatchDealGrid':{
    			storeloaded:function (grid){
    				...
    				var gridcount = Ext.getCmp('gridcount');
    				if(gridcount)
