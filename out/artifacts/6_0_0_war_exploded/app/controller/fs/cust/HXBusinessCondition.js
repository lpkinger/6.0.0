Ext.QuickTips.init();
Ext.define('erp.controller.fs.cust.HXBusinessCondition', {
	extend : 'Ext.app.Controller',
	FormUtil : Ext.create('erp.util.FormUtil'),
	views : ['core.form.Panel', 'fs.cust.HXBusinessCondition','core.form.MultiField','core.button.Save',
	...
	save: function(){
		...
		Ext.Ajax.request({
	   		url : basePath + 'fs/cust/saveHXBusinessCondition.action?_noc=1',
	   		params : params,
	   		method : 'post',
