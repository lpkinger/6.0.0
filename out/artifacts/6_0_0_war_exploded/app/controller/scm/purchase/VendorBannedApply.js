Ext.QuickTips.init();
Ext.define('erp.controller.scm.purchase.VendorBannedApply', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
    		'scm.purchase.VendorBannedApply','core.form.Panel','core.form.MultiField','core.form.FileField',
    ...
    init:function(){
		...
		this.control({
			...
			'erpAddButton': {
				click: function(){
					me.FormUtil.onAdd('addVendorBannedApply', '新增供应商禁用申请单', 'jsps/scm/purchase/vendorBannedApply.jsp');
				}
			},
			'erpCloseButton': {
				click: function(btn){
