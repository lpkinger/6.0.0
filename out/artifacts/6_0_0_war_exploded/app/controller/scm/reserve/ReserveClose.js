Ext.QuickTips.init();
Ext.define('erp.controller.scm.reserve.ReserveClose', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
    		'scm.reserve.ReserveClose',
    		'core.button.CheckPost','core.button.Close', 'core.button.CheckbeforePost', 'core.form.MonthDateField'
    	] ,
    init:function(){
		var me = this;
		this.control({         		
