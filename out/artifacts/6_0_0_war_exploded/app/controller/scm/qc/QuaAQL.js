Ext.QuickTips.init();
Ext.define('erp.controller.scm.qc.QuaAQL', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    GridUtil: Ext.create('erp.util.GridUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
      		'core.form.Panel','scm.qc.QuaAQL','core.grid.Panel2','core.toolbar.Toolbar',
    ...
    init:function(){
    	...
    	this.control({
    		...
    		'erpAddButton': {
    			click: function(){
    				me.FormUtil.onAdd('addAQL', '新增材料类型检验项目AQL设置', 'jsps/scm/qc/quaAql.jsp');
    			}
    		},
    		'erpCloseButton': {
    			click: function(btn){
