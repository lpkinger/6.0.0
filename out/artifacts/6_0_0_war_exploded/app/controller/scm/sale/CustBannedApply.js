Ext.QuickTips.init();
Ext.define('erp.controller.scm.sale.CustBannedApply', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
    		'scm.sale.CustBannedApply','core.form.Panel','core.form.MultiField','core.form.FileField',
    ...
    init:function(){
		...
		this.control({
			...
			'erpAddButton': {
				click: function(){
					me.FormUtil.onAdd('addCustBannedApply', '新增客户禁用申请单', 'jsps/scm/sale/custBannedApply.jsp');
				}
			},
			'erpCloseButton': {
				click: function(btn){
