Ext.QuickTips.init();
Ext.define('erp.controller.scm.sale.CustomerKind', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
    		'scm.sale.CustomerKind','core.form.Panel','core.button.Save','core.button.Close',
    ...
    init:function(){
    	...
    	this.control({
    		...
    		'erpDeleteButton':{
    			click: function(btn){
    				var form = me.getForm(btn);
    			    this.FormUtil.onDelete(Ext.getCmp('ck_id').getValue());
    			}
    		},
    		'erpBannedButton':{
    			click: function(btn){
    				var form = me.getForm(btn);
    			    this.FormUtil.onBanned(Ext.getCmp('ck_id').getValue());
    			}
    		},
	        'erpResBannedButton':{
	        	click: function(btn){
    				var form = me.getForm(btn);
    			    this.FormUtil.onResBanned(Ext.getCmp('ck_id').getValue());
    			}
    		},
    		'erpCloseButton': {
    			click: function(btn){
    		...
    		'button[name=delete]': {
    			click: function(){
    				...
    				if(items[0].data['ck_id'] != null || items[0].data['ck_id'] != ''){
    ...
    getFormData: function(record){
    	...
    	if(id == null || id == ''){
    		...
    		Ext.getCmp('ck_subof').setValue(record.data['parentId']);
