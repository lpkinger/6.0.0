Ext.QuickTips.init();
Ext.define('erp.controller.scm.product.Plmpreproduct', {
    extend: 'Ext.app.Controller',
    FormUtil: Ext.create('erp.util.FormUtil'),
    GridUtil: Ext.create('erp.util.GridUtil'),
    BaseUtil: Ext.create('erp.util.BaseUtil'),
    views:[
    		'scm.product.Plmpreproduct','core.form.Panel','core.grid.Panel2','core.toolbar.Toolbar',
    ...
    init:function(){
    	...
    	this.control({ 
    		...
    		'erpAddButton': {
    			click: function(){
    				me.FormUtil.onAdd('addPlmpreproduct', '新增研发新物料申请', 'jsps/scm/product/plmpreproduct.jsp');
    			}
    		},'erpSubmitButton': {
