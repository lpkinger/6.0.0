				...
				click:function(btn){	
		    		...
		    		Ext.create('Ext.window.Window',{
	   				    ...
	   				    items: [{
	   				    	  ...
	   				    	  anchor : '100% 100%',
	   				    	  layout : 'fit',
	   				    	  html : '<iframe id="iframe_dl_'+caller+'" src="'+basePath+'jsps/scm/product/ProdResource.jsp?urlcondition='+urlcondition+'&whoami=BatchUUIdSource&code='+code+'&_noc=1 &_config=CLOUD" height="100%" width="100%" frameborder="0" scrolling="auto"></iframe>'
	   				    }],
	   				    listeners:{
						    'beforeclose':function(view ,opt){
						    	 window.location.href = basePath + "jsps/scm/product/ProductBatchUUId.jsp?gridCondition=pub_code="+code+"&code="+code+'&_noc=1&_config=CLOUD'; 
						    } 
						  }
	   				}).show();  		    	
				}
