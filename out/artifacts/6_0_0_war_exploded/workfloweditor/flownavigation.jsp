...
Gef.IMAGE_ROOT = 'scripts/gef/images/activities/48/';
    ...
    <script type="text/javascript" src="scripts/all-workflowsysnavigation.js"></script>
    <script type="text/javascript" src="scripts/validation/all-validation.js"></script>
    <script type="text/javascript" src="scripts/form/sysnavigationform.js"></script>
    ...
    <script type="text/javascript" src="scripts/org/DbfindField.js"></script>
