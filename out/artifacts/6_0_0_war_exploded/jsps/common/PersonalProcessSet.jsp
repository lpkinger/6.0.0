...
<script type="text/javascript" src="<%=basePath %>resource/ext/ext-all.js"></script><script type="text/javascript" src="<%=basePath %>resource/ux/TabScrollerMenu.js"></script>
...
Ext.application({
    ...
    controllers: [//声明所用到的控制层
        'common.PersonalProcessSet'
    ],
    launch: function() {
    	Ext.create('erp.view.common.JProcess.PersonalProcessSet');//创建视图
    }
});
</script>
</head>
