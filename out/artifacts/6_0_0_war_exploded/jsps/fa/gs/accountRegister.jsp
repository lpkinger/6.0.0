...
<link rel="stylesheet" href="<%=basePath %>resource/ux/css/RowExpander.css" type="text/css"></link>
...
Ext.application({
    ...
    controllers: [//声明所用到的控制层
        'fa.gs.AccountRegister'
    ],
    launch: function() {
    	Ext.create('erp.view.fa.gs.AccountRegister');//创建视图
    }
});
