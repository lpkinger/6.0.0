...
<head>
   ...
   <script src="<%=basePath %>app/view/core/trigger/DbfindTrigger.js" type="text/javascript"></script>
  <%--   <script src="<%=basePath %>app/view/core/window/Msg.js" type="text/javascript"></script> --%>
    ...
    <script type="text/javascript">
        ...
        Ext.onReady(function(){
        	Ext.Ajax.request({//拿到grid的columns
            	url : basePath + 'plm/calendar/getData.action',
            	params:{
            	 caller:'Calendar',
                 emid:'',
            	},
