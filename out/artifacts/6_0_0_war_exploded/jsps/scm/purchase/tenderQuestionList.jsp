...
Ext.application({
    ...
    controllers: [//声明所用到的控制层
        'scm.purchase.TenderQuestionList'
    ],
    launch: function() {
    	Ext.create('erp.view.scm.purchase.TenderQuestionList');//创建视图
    }
});
var caller = 'TenderQuestionList';

var height = Ext.isIE ? screen.height : window.innerHeight;
