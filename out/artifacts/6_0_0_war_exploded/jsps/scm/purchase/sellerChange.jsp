...
Ext.application({
    ...
    controllers: [//声明所用到的控制层
        'scm.purchase.SellerChange'
    ],
    launch: function() {
    	Ext.create('erp.view.scm.purchase.SellerChange');//创建视图
    }
});
var caller = getUrlParam('whoami')|| 'SellerChange!Sale';
...
if(datalistId && datalistId!='NaN'){
	...
	caller='SellerChange!'+datalistStore.data['sc_type'];
}	
var formCondition = '';
var gridCondition = '';
</script>
